 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ag;function ZS(){if(Ag)return te;Ag=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),x=Symbol.iterator;function M(U){return U===null||typeof U!="object"?null:(U=x&&U[x]||U["@@iterator"],typeof U=="function"?U:null)}var R={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,y={};function v(U,$,gt){this.props=U,this.context=$,this.refs=y,this.updater=gt||R}v.prototype.isReactComponent={},v.prototype.setState=function(U,$){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,$,"setState")},v.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function L(){}L.prototype=v.prototype;function D(U,$,gt){this.props=U,this.context=$,this.refs=y,this.updater=gt||R}var z=D.prototype=new L;z.constructor=D,C(z,v.prototype),z.isPureReactComponent=!0;var J=Array.isArray;function I(){}var N={H:null,A:null,T:null,S:null},O=Object.prototype.hasOwnProperty;function T(U,$,gt){var G=gt.ref;return{$$typeof:o,type:U,key:$,ref:G!==void 0?G:null,props:gt}}function E(U,$){return T(U.type,$,U.props)}function q(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function st(U){var $={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(gt){return $[gt]})}var V=/\/+/g;function ht(U,$){return typeof U=="object"&&U!==null&&U.key!=null?st(""+U.key):$.toString(36)}function dt(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(I,I):(U.status="pending",U.then(function($){U.status==="pending"&&(U.status="fulfilled",U.value=$)},function($){U.status==="pending"&&(U.status="rejected",U.reason=$)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function F(U,$,gt,G,ut){var Et=typeof U;(Et==="undefined"||Et==="boolean")&&(U=null);var xt=!1;if(U===null)xt=!0;else switch(Et){case"bigint":case"string":case"number":xt=!0;break;case"object":switch(U.$$typeof){case o:case e:xt=!0;break;case _:return xt=U._init,F(xt(U._payload),$,gt,G,ut)}}if(xt)return ut=ut(U),xt=G===""?"."+ht(U,0):G,J(ut)?(gt="",xt!=null&&(gt=xt.replace(V,"$&/")+"/"),F(ut,$,gt,"",function(j){return j})):ut!=null&&(q(ut)&&(ut=E(ut,gt+(ut.key==null||U&&U.key===ut.key?"":(""+ut.key).replace(V,"$&/")+"/")+xt)),$.push(ut)),1;xt=0;var kt=G===""?".":G+":";if(J(U))for(var Pt=0;Pt<U.length;Pt++)G=U[Pt],Et=kt+ht(G,Pt),xt+=F(G,$,gt,Et,ut);else if(Pt=M(U),typeof Pt=="function")for(U=Pt.call(U),Pt=0;!(G=U.next()).done;)G=G.value,Et=kt+ht(G,Pt++),xt+=F(G,$,gt,Et,ut);else if(Et==="object"){if(typeof U.then=="function")return F(dt(U),$,gt,G,ut);throw $=String(U),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return xt}function Z(U,$,gt){if(U==null)return U;var G=[],ut=0;return F(U,G,"","",function(Et){return $.call(gt,Et,ut++)}),G}function W(U){if(U._status===-1){var $=U._result;$=$(),$.then(function(gt){(U._status===0||U._status===-1)&&(U._status=1,U._result=gt)},function(gt){(U._status===0||U._status===-1)&&(U._status=2,U._result=gt)}),U._status===-1&&(U._status=0,U._result=$)}if(U._status===1)return U._result.default;throw U._result}var vt=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},ct={map:Z,forEach:function(U,$,gt){Z(U,function(){$.apply(this,arguments)},gt)},count:function(U){var $=0;return Z(U,function(){$++}),$},toArray:function(U){return Z(U,function($){return $})||[]},only:function(U){if(!q(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return te.Activity=S,te.Children=ct,te.Component=v,te.Fragment=i,te.Profiler=l,te.PureComponent=D,te.StrictMode=r,te.Suspense=m,te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=N,te.__COMPILER_RUNTIME={__proto__:null,c:function(U){return N.H.useMemoCache(U)}},te.cache=function(U){return function(){return U.apply(null,arguments)}},te.cacheSignal=function(){return null},te.cloneElement=function(U,$,gt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var G=C({},U.props),ut=U.key;if($!=null)for(Et in $.key!==void 0&&(ut=""+$.key),$)!O.call($,Et)||Et==="key"||Et==="__self"||Et==="__source"||Et==="ref"&&$.ref===void 0||(G[Et]=$[Et]);var Et=arguments.length-2;if(Et===1)G.children=gt;else if(1<Et){for(var xt=Array(Et),kt=0;kt<Et;kt++)xt[kt]=arguments[kt+2];G.children=xt}return T(U.type,ut,G)},te.createContext=function(U){return U={$$typeof:d,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:c,_context:U},U},te.createElement=function(U,$,gt){var G,ut={},Et=null;if($!=null)for(G in $.key!==void 0&&(Et=""+$.key),$)O.call($,G)&&G!=="key"&&G!=="__self"&&G!=="__source"&&(ut[G]=$[G]);var xt=arguments.length-2;if(xt===1)ut.children=gt;else if(1<xt){for(var kt=Array(xt),Pt=0;Pt<xt;Pt++)kt[Pt]=arguments[Pt+2];ut.children=kt}if(U&&U.defaultProps)for(G in xt=U.defaultProps,xt)ut[G]===void 0&&(ut[G]=xt[G]);return T(U,Et,ut)},te.createRef=function(){return{current:null}},te.forwardRef=function(U){return{$$typeof:h,render:U}},te.isValidElement=q,te.lazy=function(U){return{$$typeof:_,_payload:{_status:-1,_result:U},_init:W}},te.memo=function(U,$){return{$$typeof:p,type:U,compare:$===void 0?null:$}},te.startTransition=function(U){var $=N.T,gt={};N.T=gt;try{var G=U(),ut=N.S;ut!==null&&ut(gt,G),typeof G=="object"&&G!==null&&typeof G.then=="function"&&G.then(I,vt)}catch(Et){vt(Et)}finally{$!==null&&gt.types!==null&&($.types=gt.types),N.T=$}},te.unstable_useCacheRefresh=function(){return N.H.useCacheRefresh()},te.use=function(U){return N.H.use(U)},te.useActionState=function(U,$,gt){return N.H.useActionState(U,$,gt)},te.useCallback=function(U,$){return N.H.useCallback(U,$)},te.useContext=function(U){return N.H.useContext(U)},te.useDebugValue=function(){},te.useDeferredValue=function(U,$){return N.H.useDeferredValue(U,$)},te.useEffect=function(U,$){return N.H.useEffect(U,$)},te.useEffectEvent=function(U){return N.H.useEffectEvent(U)},te.useId=function(){return N.H.useId()},te.useImperativeHandle=function(U,$,gt){return N.H.useImperativeHandle(U,$,gt)},te.useInsertionEffect=function(U,$){return N.H.useInsertionEffect(U,$)},te.useLayoutEffect=function(U,$){return N.H.useLayoutEffect(U,$)},te.useMemo=function(U,$){return N.H.useMemo(U,$)},te.useOptimistic=function(U,$){return N.H.useOptimistic(U,$)},te.useReducer=function(U,$,gt){return N.H.useReducer(U,$,gt)},te.useRef=function(U){return N.H.useRef(U)},te.useState=function(U){return N.H.useState(U)},te.useSyncExternalStore=function(U,$,gt){return N.H.useSyncExternalStore(U,$,gt)},te.useTransition=function(){return N.H.useTransition()},te.version="19.2.0",te}var bg;function Nh(){return bg||(bg=1,Bf.exports=ZS()),Bf.exports}var mu=Nh();const KS=sv(mu);var If={exports:{}},So={},Ff={exports:{}},Hf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rg;function QS(){return Rg||(Rg=1,(function(o){function e(F,Z){var W=F.length;F.push(Z);t:for(;0<W;){var vt=W-1>>>1,ct=F[vt];if(0<l(ct,Z))F[vt]=Z,F[W]=ct,W=vt;else break t}}function i(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var Z=F[0],W=F.pop();if(W!==Z){F[0]=W;t:for(var vt=0,ct=F.length,U=ct>>>1;vt<U;){var $=2*(vt+1)-1,gt=F[$],G=$+1,ut=F[G];if(0>l(gt,W))G<ct&&0>l(ut,gt)?(F[vt]=ut,F[G]=W,vt=G):(F[vt]=gt,F[$]=W,vt=$);else if(G<ct&&0>l(ut,W))F[vt]=ut,F[G]=W,vt=G;else break t}}return Z}function l(F,Z){var W=F.sortIndex-Z.sortIndex;return W!==0?W:F.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],_=1,S=null,x=3,M=!1,R=!1,C=!1,y=!1,v=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function z(F){for(var Z=i(p);Z!==null;){if(Z.callback===null)r(p);else if(Z.startTime<=F)r(p),Z.sortIndex=Z.expirationTime,e(m,Z);else break;Z=i(p)}}function J(F){if(C=!1,z(F),!R)if(i(m)!==null)R=!0,I||(I=!0,st());else{var Z=i(p);Z!==null&&dt(J,Z.startTime-F)}}var I=!1,N=-1,O=5,T=-1;function E(){return y?!0:!(o.unstable_now()-T<O)}function q(){if(y=!1,I){var F=o.unstable_now();T=F;var Z=!0;try{t:{R=!1,C&&(C=!1,L(N),N=-1),M=!0;var W=x;try{e:{for(z(F),S=i(m);S!==null&&!(S.expirationTime>F&&E());){var vt=S.callback;if(typeof vt=="function"){S.callback=null,x=S.priorityLevel;var ct=vt(S.expirationTime<=F);if(F=o.unstable_now(),typeof ct=="function"){S.callback=ct,z(F),Z=!0;break e}S===i(m)&&r(m),z(F)}else r(m);S=i(m)}if(S!==null)Z=!0;else{var U=i(p);U!==null&&dt(J,U.startTime-F),Z=!1}}break t}finally{S=null,x=W,M=!1}Z=void 0}}finally{Z?st():I=!1}}}var st;if(typeof D=="function")st=function(){D(q)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,ht=V.port2;V.port1.onmessage=q,st=function(){ht.postMessage(null)}}else st=function(){v(q,0)};function dt(F,Z){N=v(function(){F(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(F){F.callback=null},o.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):O=0<F?Math.floor(1e3/F):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(F){switch(x){case 1:case 2:case 3:var Z=3;break;default:Z=x}var W=x;x=Z;try{return F()}finally{x=W}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(F,Z){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var W=x;x=F;try{return Z()}finally{x=W}},o.unstable_scheduleCallback=function(F,Z,W){var vt=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?vt+W:vt):W=vt,F){case 1:var ct=-1;break;case 2:ct=250;break;case 5:ct=1073741823;break;case 4:ct=1e4;break;default:ct=5e3}return ct=W+ct,F={id:_++,callback:Z,priorityLevel:F,startTime:W,expirationTime:ct,sortIndex:-1},W>vt?(F.sortIndex=W,e(p,F),i(m)===null&&F===i(p)&&(C?(L(N),N=-1):C=!0,dt(J,W-vt))):(F.sortIndex=ct,e(m,F),R||M||(R=!0,I||(I=!0,st()))),F},o.unstable_shouldYield=E,o.unstable_wrapCallback=function(F){var Z=x;return function(){var W=x;x=Z;try{return F.apply(this,arguments)}finally{x=W}}}})(Hf)),Hf}var Cg;function JS(){return Cg||(Cg=1,Ff.exports=QS()),Ff.exports}var Gf={exports:{}},_n={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wg;function $S(){if(wg)return _n;wg=1;var o=Nh();function e(m){var p="https://react.dev/errors/"+m;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)p+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var r={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(m,p,_){var S=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:S==null?null:""+S,children:m,containerInfo:p,implementation:_}}var d=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function h(m,p){if(m==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return _n.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,_n.createPortal=function(m,p){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(e(299));return c(m,p,null,_)},_n.flushSync=function(m){var p=d.T,_=r.p;try{if(d.T=null,r.p=2,m)return m()}finally{d.T=p,r.p=_,r.d.f()}},_n.preconnect=function(m,p){typeof m=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,r.d.C(m,p))},_n.prefetchDNS=function(m){typeof m=="string"&&r.d.D(m)},_n.preinit=function(m,p){if(typeof m=="string"&&p&&typeof p.as=="string"){var _=p.as,S=h(_,p.crossOrigin),x=typeof p.integrity=="string"?p.integrity:void 0,M=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;_==="style"?r.d.S(m,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:S,integrity:x,fetchPriority:M}):_==="script"&&r.d.X(m,{crossOrigin:S,integrity:x,fetchPriority:M,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},_n.preinitModule=function(m,p){if(typeof m=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var _=h(p.as,p.crossOrigin);r.d.M(m,{crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&r.d.M(m)},_n.preload=function(m,p){if(typeof m=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var _=p.as,S=h(_,p.crossOrigin);r.d.L(m,_,{crossOrigin:S,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},_n.preloadModule=function(m,p){if(typeof m=="string")if(p){var _=h(p.as,p.crossOrigin);r.d.m(m,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else r.d.m(m)},_n.requestFormReset=function(m){r.d.r(m)},_n.unstable_batchedUpdates=function(m,p){return m(p)},_n.useFormState=function(m,p,_){return d.H.useFormState(m,p,_)},_n.useFormStatus=function(){return d.H.useHostTransitionStatus()},_n.version="19.2.0",_n}var Dg;function tx(){if(Dg)return Gf.exports;Dg=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(e){console.error(e)}}return o(),Gf.exports=$S(),Gf.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ug;function ex(){if(Ug)return So;Ug=1;var o=JS(),e=Nh(),i=tx();function r(t){var n="https://react.dev/errors/"+t;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function c(t){var n=t,a=t;if(t.alternate)for(;n.return;)n=n.return;else{t=n;do n=t,(n.flags&4098)!==0&&(a=n.return),t=n.return;while(t)}return n.tag===3?a:null}function d(t){if(t.tag===13){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function h(t){if(t.tag===31){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function m(t){if(c(t)!==t)throw Error(r(188))}function p(t){var n=t.alternate;if(!n){if(n=c(t),n===null)throw Error(r(188));return n!==t?null:t}for(var a=t,s=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(s=u.return,s!==null){a=s;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return m(u),t;if(f===s)return m(u),n;f=f.sibling}throw Error(r(188))}if(a.return!==s.return)a=u,s=f;else{for(var g=!1,A=u.child;A;){if(A===a){g=!0,a=u,s=f;break}if(A===s){g=!0,s=u,a=f;break}A=A.sibling}if(!g){for(A=f.child;A;){if(A===a){g=!0,a=f,s=u;break}if(A===s){g=!0,s=f,a=u;break}A=A.sibling}if(!g)throw Error(r(189))}}if(a.alternate!==s)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?t:n}function _(t){var n=t.tag;if(n===5||n===26||n===27||n===6)return t;for(t=t.child;t!==null;){if(n=_(t),n!==null)return n;t=t.sibling}return null}var S=Object.assign,x=Symbol.for("react.element"),M=Symbol.for("react.transitional.element"),R=Symbol.for("react.portal"),C=Symbol.for("react.fragment"),y=Symbol.for("react.strict_mode"),v=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),D=Symbol.for("react.context"),z=Symbol.for("react.forward_ref"),J=Symbol.for("react.suspense"),I=Symbol.for("react.suspense_list"),N=Symbol.for("react.memo"),O=Symbol.for("react.lazy"),T=Symbol.for("react.activity"),E=Symbol.for("react.memo_cache_sentinel"),q=Symbol.iterator;function st(t){return t===null||typeof t!="object"?null:(t=q&&t[q]||t["@@iterator"],typeof t=="function"?t:null)}var V=Symbol.for("react.client.reference");function ht(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===V?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case C:return"Fragment";case v:return"Profiler";case y:return"StrictMode";case J:return"Suspense";case I:return"SuspenseList";case T:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case R:return"Portal";case D:return t.displayName||"Context";case L:return(t._context.displayName||"Context")+".Consumer";case z:var n=t.render;return t=t.displayName,t||(t=n.displayName||n.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case N:return n=t.displayName||null,n!==null?n:ht(t.type)||"Memo";case O:n=t._payload,t=t._init;try{return ht(t(n))}catch{}}return null}var dt=Array.isArray,F=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W={pending:!1,data:null,method:null,action:null},vt=[],ct=-1;function U(t){return{current:t}}function $(t){0>ct||(t.current=vt[ct],vt[ct]=null,ct--)}function gt(t,n){ct++,vt[ct]=t.current,t.current=n}var G=U(null),ut=U(null),Et=U(null),xt=U(null);function kt(t,n){switch(gt(Et,n),gt(ut,t),gt(G,null),n.nodeType){case 9:case 11:t=(t=n.documentElement)&&(t=t.namespaceURI)?qm(t):0;break;default:if(t=n.tagName,n=n.namespaceURI)n=qm(n),t=Ym(n,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}$(G),gt(G,t)}function Pt(){$(G),$(ut),$(Et)}function j(t){t.memoizedState!==null&&gt(xt,t);var n=G.current,a=Ym(n,t.type);n!==a&&(gt(ut,t),gt(G,a))}function ee(t){ut.current===t&&($(G),$(ut)),xt.current===t&&($(xt),po._currentValue=W)}var Gt,ve;function It(t){if(Gt===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Gt=n&&n[1]||"",ve=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Gt+t+ve}var ie=!1;function Qt(t,n){if(!t||ie)return"";ie=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var s={DetermineComponentFrameRoot:function(){try{if(n){var _t=function(){throw Error()};if(Object.defineProperty(_t.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(_t,[])}catch(at){var et=at}Reflect.construct(t,[],_t)}else{try{_t.call()}catch(at){et=at}t.call(_t.prototype)}}else{try{throw Error()}catch(at){et=at}(_t=t())&&typeof _t.catch=="function"&&_t.catch(function(){})}}catch(at){if(at&&et&&typeof at.stack=="string")return[at.stack,et.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=s.DetermineComponentFrameRoot(),g=f[0],A=f[1];if(g&&A){var B=g.split(`
`),Q=A.split(`
...
`)+`
`+v);const D=L+y+d,z=L+v+h,J=k_(l,l.VERTEX_SHADER,D),I=k_(l,l.FRAGMENT_SHADER,z);l.attachShader(C,J),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function N(q){if(o.debug.checkShaderErrors){const st=l.getProgramInfoLog(C).trim(),V=l.getShaderInfoLog(J).trim(),ht=l.getShaderInfoLog(I).trim();let dt=!0,F=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(dt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,J,I);else{const Z=W_(l,J,"vertex"),W=W_(l,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
Program Info Log: `+st+`
`+Z+`
`+W)}else st!==""?console.warn("THREE.WebGLProgram: Program Info Log:",st):(V===""||ht==="")&&(F=!1);F&&(q.diagnostics={runnable:dt,programLog:st,vertexShader:{log:V,prefix:y},fragmentShader:{log:ht,prefix:v}})}l.deleteShader(J),l.deleteShader(I),O=new gu(l,C),T=CA(l,C)}let O;this.getUniforms=function(){return O===void 0&&N(this),O};let T;this.getAttributes=function(){return T===void 0&&N(this),T};let E=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return E===!1&&(E=l.getProgramParameter(C,xA)),E},this.destroy=function(){r.releaseStatesOfProgram(this),l.deleteProgram(C),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=yA++,this.cacheKey=e,this.usedTimes=1,this.program=C,this.vertexShader=J,this.fragmentShader=I,this}let HA=0;class GA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const i=e.vertexShader,r=e.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(r),d=this._getShaderCacheForMaterial(e);return d.has(l)===!1&&(d.add(l),l.usedTimes++),d.has(c)===!1&&(d.add(c),c.usedTimes++),this}remove(e){const i=this.materialCache.get(e);for(const r of i)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const i=this.materialCache;let r=i.get(e);return r===void 0&&(r=new Set,i.set(e,r)),r}_getShaderStage(e){const i=this.shaderCache;let r=i.get(e);return r===void 0&&(r=new VA(e),i.set(e,r)),r}}class VA{constructor(e){this.id=HA++,this.code=e,this.usedTimes=0}}function XA(o,e,i,r,l,c,d){const h=new Ph,m=new GA,p=new Set,_=[],S=l.logarithmicDepthBuffer,x=l.vertexTextures;let M=l.precision;const R={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function C(T){return p.add(T),T===0?"uv":`uv${T}`}function y(T,E,q,st,V){const ht=st.fog,dt=V.geometry,F=T.isMeshStandardMaterial?st.environment:null,Z=(T.isMeshStandardMaterial?i:e).get(T.envMap||F),W=Z&&Z.mapping===Eu?Z.image.height:null,vt=R[T.type];T.precision!==null&&(M=l.getMaxPrecision(T.precision),M!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",M,"instead."));const ct=dt.morphAttributes.position||dt.morphAttributes.normal||dt.morphAttributes.color,U=ct!==void 0?ct.length:0;let $=0;dt.morphAttributes.position!==void 0&&($=1),dt.morphAttributes.normal!==void 0&&($=2),dt.morphAttributes.color!==void 0&&($=3);let gt,G,ut,Et;if(vt){const xe=xi[vt];gt=xe.vertexShader,G=xe.fragmentShader}else gt=T.vertexShader,G=T.fragmentShader,m.update(T),ut=m.getVertexShaderID(T),Et=m.getFragmentShaderID(T);const xt=o.getRenderTarget(),kt=V.isInstancedMesh===!0,Pt=V.isBatchedMesh===!0,j=!!T.map,ee=!!T.matcap,Gt=!!Z,ve=!!T.aoMap,It=!!T.lightMap,ie=!!T.bumpMap,Qt=!!T.normalMap,ae=!!T.displacementMap,Ce=!!T.emissiveMap,P=!!T.metalnessMap,b=!!T.roughnessMap,ot=T.anisotropy>0,lt=T.clearcoat>0,yt=T.dispersion>0,St=T.iridescence>0,Lt=T.sheen>0,At=T.transmission>0,Tt=ot&&!!T.anisotropyMap,jt=lt&&!!T.clearcoatMap,bt=lt&&!!T.clearcoatNormalMap,Ft=lt&&!!T.clearcoatRoughnessMap,fe=St&&!!T.iridescenceMap,Wt=St&&!!T.iridescenceThicknessMap,Dt=Lt&&!!T.sheenColorMap,qt=Lt&&!!T.sheenRoughnessMap,$t=!!T.specularMap,ge=!!T.specularColorMap,re=!!T.specularIntensityMap,X=At&&!!T.transmissionMap,Mt=At&&!!T.thicknessMap,mt=!!T.gradientMap,Ct=!!T.alphaMap,Ut=T.alphaTest>0,le=!!T.alphaHash,Ae=!!T.extensions;let we=Na;T.toneMapped&&(xt===null||xt.isXRRenderTarget===!0)&&(we=o.toneMapping);const sn={shaderID:vt,shaderType:T.type,shaderName:T.name,vertexShader:gt,fragmentShader:G,defines:T.defines,customVertexShaderID:ut,customFragmentShaderID:Et,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:M,batching:Pt,instancing:kt,instancingColor:kt&&V.instanceColor!==null,instancingMorph:kt&&V.morphTexture!==null,supportsVertexTextures:x,outputColorSpace:xt===null?o.outputColorSpace:xt.isXRRenderTarget===!0?xt.texture.colorSpace:Pa,alphaToCoverage:!!T.alphaToCoverage,map:j,matcap:ee,envMap:Gt,envMapMode:Gt&&Z.mapping,envMapCubeUVHeight:W,aoMap:ve,lightMap:It,bumpMap:ie,normalMap:Qt,displacementMap:x&&ae,emissiveMap:Ce,normalMapObjectSpace:Qt&&T.normalMapType===ty,normalMapTangentSpace:Qt&&T.normalMapType===vv,metalnessMap:P,roughnessMap:b,anisotropy:ot,anisotropyMap:Tt,clearcoat:lt,clearcoatMap:jt,clearcoatNormalMap:bt,clearcoatRoughnessMap:Ft,dispersion:yt,iridescence:St,iridescenceMap:fe,iridescenceThicknessMap:Wt,sheen:Lt,sheenColorMap:Dt,sheenRoughnessMap:qt,specularMap:$t,specularColorMap:ge,specularIntensityMap:re,transmission:At,transmissionMap:X,thicknessMap:Mt,gradientMap:mt,opaque:T.transparent===!1&&T.blending===gs&&T.alphaToCoverage===!1,alphaMap:Ct,alphaTest:Ut,alphaHash:le,combine:T.combine,mapUv:j&&C(T.map.channel),aoMapUv:ve&&C(T.aoMap.channel),lightMapUv:It&&C(T.lightMap.channel),bumpMapUv:ie&&C(T.bumpMap.channel),normalMapUv:Qt&&C(T.normalMap.channel),displacementMapUv:ae&&C(T.displacementMap.channel),emissiveMapUv:Ce&&C(T.emissiveMap.channel),metalnessMapUv:P&&C(T.metalnessMap.channel),roughnessMapUv:b&&C(T.roughnessMap.channel),anisotropyMapUv:Tt&&C(T.anisotropyMap.channel),clearcoatMapUv:jt&&C(T.clearcoatMap.channel),clearcoatNormalMapUv:bt&&C(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ft&&C(T.clearcoatRoughnessMap.channel),iridescenceMapUv:fe&&C(T.iridescenceMap.channel),iridescenceThicknessMapUv:Wt&&C(T.iridescenceThicknessMap.channel),sheenColorMapUv:Dt&&C(T.sheenColorMap.channel),sheenRoughnessMapUv:qt&&C(T.sheenRoughnessMap.channel),specularMapUv:$t&&C(T.specularMap.channel),specularColorMapUv:ge&&C(T.specularColorMap.channel),specularIntensityMapUv:re&&C(T.specularIntensityMap.channel),transmissionMapUv:X&&C(T.transmissionMap.channel),thicknessMapUv:Mt&&C(T.thicknessMap.channel),alphaMapUv:Ct&&C(T.alphaMap.channel),vertexTangents:!!dt.attributes.tangent&&(Qt||ot),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!dt.attributes.color&&dt.attributes.color.itemSize===4,pointsUvs:V.isPoints===!0&&!!dt.attributes.uv&&(j||Ct),fog:!!ht,useFog:T.fog===!0,fogExp2:!!ht&&ht.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:S,skinning:V.isSkinnedMesh===!0,morphTargets:dt.morphAttributes.position!==void 0,morphNormals:dt.morphAttributes.normal!==void 0,morphColors:dt.morphAttributes.color!==void 0,morphTargetsCount:U,morphTextureStride:$,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:d.numPlanes,numClipIntersection:d.numIntersection,dithering:T.dithering,shadowMapEnabled:o.shadowMap.enabled&&q.length>0,shadowMapType:o.shadowMap.type,toneMapping:we,useLegacyLights:o._useLegacyLights,decodeVideoTexture:j&&T.map.isVideoTexture===!0&&Ne.getTransfer(T.map.colorSpace)===Fe,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===Yi,flipSided:T.side===Cn,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:Ae&&T.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:Ae&&T.extensions.multiDraw===!0&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return sn.vertexUv1s=p.has(1),sn.vertexUv2s=p.has(2),sn.vertexUv3s=p.has(3),p.clear(),sn}function v(T){const E=[];if(T.shaderID?E.push(T.shaderID):(E.push(T.customVertexShaderID),E.push(T.customFragmentShaderID)),T.defines!==void 0)for(const q in T.defines)E.push(q),E.push(T.defines[q]);return T.isRawShaderMaterial===!1&&(L(E,T),D(E,T),E.push(o.outputColorSpace)),E.push(T.customProgramCacheKey),E.join()}function L(T,E){T.push(E.precision),T.push(E.outputColorSpace),T.push(E.envMapMode),T.push(E.envMapCubeUVHeight),T.push(E.mapUv),T.push(E.alphaMapUv),T.push(E.lightMapUv),T.push(E.aoMapUv),T.push(E.bumpMapUv),T.push(E.normalMapUv),T.push(E.displacementMapUv),T.push(E.emissiveMapUv),T.push(E.metalnessMapUv),T.push(E.roughnessMapUv),T.push(E.anisotropyMapUv),T.push(E.clearcoatMapUv),T.push(E.clearcoatNormalMapUv),T.push(E.clearcoatRoughnessMapUv),T.push(E.iridescenceMapUv),T.push(E.iridescenceThicknessMapUv),T.push(E.sheenColorMapUv),T.push(E.sheenRoughnessMapUv),T.push(E.specularMapUv),T.push(E.specularColorMapUv),T.push(E.specularIntensityMapUv),T.push(E.transmissionMapUv),T.push(E.thicknessMapUv),T.push(E.combine),T.push(E.fogExp2),T.push(E.sizeAttenuation),T.push(E.morphTargetsCount),T.push(E.morphAttributeCount),T.push(E.numDirLights),T.push(E.numPointLights),T.push(E.numSpotLights),T.push(E.numSpotLightMaps),T.push(E.numHemiLights),T.push(E.numRectAreaLights),T.push(E.numDirLightShadows),T.push(E.numPointLightShadows),T.push(E.numSpotLightShadows),T.push(E.numSpotLightShadowsWithMaps),T.push(E.numLightProbes),T.push(E.shadowMapType),T.push(E.toneMapping),T.push(E.numClippingPlanes),T.push(E.numClipIntersection),T.push(E.depthPacking)}function D(T,E){h.disableAll(),E.supportsVertexTextures&&h.enable(0),E.instancing&&h.enable(1),E.instancingColor&&h.enable(2),E.instancingMorph&&h.enable(3),E.matcap&&h.enable(4),E.envMap&&h.enable(5),E.normalMapObjectSpace&&h.enable(6),E.normalMapTangentSpace&&h.enable(7),E.clearcoat&&h.enable(8),E.iridescence&&h.enable(9),E.alphaTest&&h.enable(10),E.vertexColors&&h.enable(11),E.vertexAlphas&&h.enable(12),E.vertexUv1s&&h.enable(13),E.vertexUv2s&&h.enable(14),E.vertexUv3s&&h.enable(15),E.vertexTangents&&h.enable(16),E.anisotropy&&h.enable(17),E.alphaHash&&h.enable(18),E.batching&&h.enable(19),E.dispersion&&h.enable(20),T.push(h.mask),h.disableAll(),E.fog&&h.enable(0),E.useFog&&h.enable(1),E.flatShading&&h.enable(2),E.logarithmicDepthBuffer&&h.enable(3),E.skinning&&h.enable(4),E.morphTargets&&h.enable(5),E.morphNormals&&h.enable(6),E.morphColors&&h.enable(7),E.premultipliedAlpha&&h.enable(8),E.shadowMapEnabled&&h.enable(9),E.useLegacyLights&&h.enable(10),E.doubleSided&&h.enable(11),E.flipSided&&h.enable(12),E.useDepthPacking&&h.enable(13),E.dithering&&h.enable(14),E.transmission&&h.enable(15),E.sheen&&h.enable(16),E.opaque&&h.enable(17),E.pointsUvs&&h.enable(18),E.decodeVideoTexture&&h.enable(19),E.alphaToCoverage&&h.enable(20),T.push(h.mask)}function z(T){const E=R[T.type];let q;if(E){const st=xi[E];q=wv.clone(st.uniforms)}else q=T.uniforms;return q}function J(T,E){let q;for(let st=0,V=_.length;st<V;st++){const ht=_[st];if(ht.cacheKey===E){q=ht,++q.usedTimes;break}}return q===void 0&&(q=new FA(o,E,T,c),_.push(q)),q}function I(T){if(--T.usedTimes===0){const E=_.indexOf(T);_[E]=_[_.length-1],_.pop(),T.destroy()}}function N(T){m.remove(T)}function O(){m.dispose()}return{getParameters:y,getProgramCacheKey:v,getUniforms:z,acquireProgram:J,releaseProgram:I,releaseShaderCache:N,programs:_,dispose:O}}function kA(){let o=new WeakMap;function e(c){let d=o.get(c);return d===void 0&&(d={},o.set(c,d)),d}function i(c){o.delete(c)}function r(c,d,h){o.get(c)[d]=h}function l(){o=new WeakMap}return{get:e,remove:i,update:r,dispose:l}}function WA(o,e){return o.groupOrder!==e.groupOrder?o.groupOrder-e.groupOrder:o.renderOrder!==e.renderOrder?o.renderOrder-e.renderOrder:o.material.id!==e.material.id?o.material.id-e.material.id:o.z!==e.z?o.z-e.z:o.id-e.id}function K_(o,e){return o.groupOrder!==e.groupOrder?o.groupOrder-e.groupOrder:o.renderOrder!==e.renderOrder?o.renderOrder-e.renderOrder:o.z!==e.z?e.z-o.z:o.id-e.id}function Q_(){const o=[];let e=0;const i=[],r=[],l=[];function c(){e=0,i.length=0,r.length=0,l.length=0}function d(S,x,M,R,C,y){let v=o[e];return v===void 0?(v={id:S.id,object:S,geometry:x,material:M,groupOrder:R,renderOrder:S.renderOrder,z:C,group:y},o[e]=v):(v.id=S.id,v.object=S,v.geometry=x,v.material=M,v.groupOrder=R,v.renderOrder=S.renderOrder,v.z=C,v.group=y),e++,v}function h(S,x,M,R,C,y){const v=d(S,x,M,R,C,y);M.transmission>0?r.push(v):M.transparent===!0?l.push(v):i.push(v)}function m(S,x,M,R,C,y){const v=d(S,x,M,R,C,y);M.transmission>0?r.unshift(v):M.transparent===!0?l.unshift(v):i.unshift(v)}function p(S,x){i.length>1&&i.sort(S||WA),r.length>1&&r.sort(x||K_),l.length>1&&l.sort(x||K_)}function _(){for(let S=e,x=o.length;S<x;S++){const M=o[S];if(M.id===null)break;M.id=null,M.object=null,M.geometry=null,M.material=null,M.group=null}}return{opaque:i,transmissive:r,transparent:l,init:c,push:h,unshift:m,finish:_,sort:p}}function qA(){let o=new WeakMap;function e(r,l){const c=o.get(r);let d;return c===void 0?(d=new Q_,o.set(r,[d])):l>=c.length?(d=new Q_,c.push(d)):d=c[l],d}function i(){o=new WeakMap}return{get:e,dispose:i}}function YA(){const o={};return{get:function(e){if(o[e.id]!==void 0)return o[e.id];let i;switch(e.type){case"DirectionalLight":i={direction:new tt,color:new Se};break;case"SpotLight":i={position:new tt,direction:new tt,color:new Se,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new tt,color:new Se,distance:0,decay:0};break;case"HemisphereLight":i={direction:new tt,skyColor:new Se,groundColor:new Se};break;case"RectAreaLight":i={color:new Se,position:new tt,halfWidth:new tt,halfHeight:new tt};break}return o[e.id]=i,i}}}function jA(){const o={};return{get:function(e){if(o[e.id]!==void 0)return o[e.id];let i;switch(e.type){case"DirectionalLight":i={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new oe};break;case"SpotLight":i={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new oe};break;case"PointLight":i={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new oe,shadowCameraNear:1,shadowCameraFar:1e3};break}return o[e.id]=i,i}}}let ZA=0;function KA(o,e){return(e.castShadow?2:0)-(o.castShadow?2:0)+(e.map?1:0)-(o.map?1:0)}function QA(o){const e=new YA,i=jA(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)r.probe.push(new tt);const l=new tt,c=new Pe,d=new Pe;function h(p,_){let S=0,x=0,M=0;for(let q=0;q<9;q++)r.probe[q].set(0,0,0);let R=0,C=0,y=0,v=0,L=0,D=0,z=0,J=0,I=0,N=0,O=0;p.sort(KA);const T=_===!0?Math.PI:1;for(let q=0,st=p.length;q<st;q++){const V=p[q],ht=V.color,dt=V.intensity,F=V.distance,Z=V.shadow&&V.shadow.map?V.shadow.map.texture:null;if(V.isAmbientLight)S+=ht.r*dt*T,x+=ht.g*dt*T,M+=ht.b*dt*T;else if(V.isLightProbe){for(let W=0;W<9;W++)r.probe[W].addScaledVector(V.sh.coefficients[W],dt);O++}else if(V.isDirectionalLight){const W=e.get(V);if(W.color.copy(V.color).multiplyScalar(V.intensity*T),V.castShadow){const vt=V.shadow,ct=i.get(V);ct.shadowBias=vt.bias,ct.shadowNormalBias=vt.normalBias,ct.shadowRadius=vt.radius,ct.shadowMapSize=vt.mapSize,r.directionalShadow[R]=ct,r.directionalShadowMap[R]=Z,r.directionalShadowMatrix[R]=V.shadow.matrix,D++}r.directional[R]=W,R++}else if(V.isSpotLight){const W=e.get(V);W.position.setFromMatrixPosition(V.matrixWorld),W.color.copy(ht).multiplyScalar(dt*T),W.distance=F,W.coneCos=Math.cos(V.angle),W.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),W.decay=V.decay,r.spot[y]=W;const vt=V.shadow;if(V.map&&(r.spotLightMap[I]=V.map,I++,vt.updateMatrices(V),V.castShadow&&N++),r.spotLightMatrix[y]=vt.matrix,V.castShadow){const ct=i.get(V);ct.shadowBias=vt.bias,ct.shadowNormalBias=vt.normalBias,ct.shadowRadius=vt.radius,ct.shadowMapSize=vt.mapSize,r.spotShadow[y]=ct,r.spotShadowMap[y]=Z,J++}y++}else if(V.isRectAreaLight){const W=e.get(V);W.color.copy(ht).multiplyScalar(dt),W.halfWidth.set(V.width*.5,0,0),W.halfHeight.set(0,V.height*.5,0),r.rectArea[v]=W,v++}else if(V.isPointLight){const W=e.get(V);if(W.color.copy(V.color).multiplyScalar(V.intensity*T),W.distance=V.distance,W.decay=V.decay,V.castShadow){const vt=V.shadow,ct=i.get(V);ct.shadowBias=vt.bias,ct.shadowNormalBias=vt.normalBias,ct.shadowRadius=vt.radius,ct.shadowMapSize=vt.mapSize,ct.shadowCameraNear=vt.camera.near,ct.shadowCameraFar=vt.camera.far,r.pointShadow[C]=ct,r.pointShadowMap[C]=Z,r.pointShadowMatrix[C]=V.shadow.matrix,z++}r.point[C]=W,C++}else if(V.isHemisphereLight){const W=e.get(V);W.skyColor.copy(V.color).multiplyScalar(dt*T),W.groundColor.copy(V.groundColor).multiplyScalar(dt*T),r.hemi[L]=W,L++}}v>0&&(o.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=wt.LTC_FLOAT_1,r.rectAreaLTC2=wt.LTC_FLOAT_2):(r.rectAreaLTC1=wt.LTC_HALF_1,r.rectAreaLTC2=wt.LTC_HALF_2)),r.ambient[0]=S,r.ambient[1]=x,r.ambient[2]=M;const E=r.hash;(E.directionalLength!==R||E.pointLength!==C||E.spotLength!==y||E.rectAreaLength!==v||E.hemiLength!==L||E.numDirectionalShadows!==D||E.numPointShadows!==z||E.numSpotShadows!==J||E.numSpotMaps!==I||E.numLightProbes!==O)&&(r.directional.length=R,r.spot.length=y,r.rectArea.length=v,r.point.length=C,r.hemi.length=L,r.directionalShadow.length=D,r.directionalShadowMap.length=D,r.pointShadow.length=z,r.pointShadowMap.length=z,r.spotShadow.length=J,r.spotShadowMap.length=J,r.directionalShadowMatrix.length=D,r.pointShadowMatrix.length=z,r.spotLightMatrix.length=J+I-N,r.spotLightMap.length=I,r.numSpotLightShadowsWithMaps=N,r.numLightProbes=O,E.directionalLength=R,E.pointLength=C,E.spotLength=y,E.rectAreaLength=v,E.hemiLength=L,E.numDirectionalShadows=D,E.numPointShadows=z,E.numSpotShadows=J,E.numSpotMaps=I,E.numLightProbes=O,r.version=ZA++)}function m(p,_){let S=0,x=0,M=0,R=0,C=0;const y=_.matrixWorldInverse;for(let v=0,L=p.length;v<L;v++){const D=p[v];if(D.isDirectionalLight){const z=r.directional[S];z.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),z.direction.sub(l),z.direction.transformDirection(y),S++}else if(D.isSpotLight){const z=r.spot[M];z.position.setFromMatrixPosition(D.matrixWorld),z.position.applyMatrix4(y),z.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),z.direction.sub(l),z.direction.transformDirection(y),M++}else if(D.isRectAreaLight){const z=r.rectArea[R];z.position.setFromMatrixPosition(D.matrixWorld),z.position.applyMatrix4(y),d.identity(),c.copy(D.matrixWorld),c.premultiply(y),d.extractRotation(c),z.halfWidth.set(D.width*.5,0,0),z.halfHeight.set(0,D.height*.5,0),z.halfWidth.applyMatrix4(d),z.halfHeight.applyMatrix4(d),R++}else if(D.isPointLight){const z=r.point[x];z.position.setFromMatrixPosition(D.matrixWorld),z.position.applyMatrix4(y),x++}else if(D.isHemisphereLight){const z=r.hemi[C];z.direction.setFromMatrixPosition(D.matrixWorld),z.direction.transformDirection(y),C++}}}return{setup:h,setupView:m,state:r}}function J_(o){const e=new QA(o),i=[],r=[];function l(_){p.camera=_,i.length=0,r.length=0}function c(_){i.push(_)}function d(_){r.push(_)}function h(_){e.setup(i,_)}function m(_){e.setupView(i,_)}const p={lightsArray:i,shadowsArray:r,camera:null,lights:e,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:h,setupLightsView:m,pushLight:c,pushShadow:d}}function JA(o){let e=new WeakMap;function i(l,c=0){const d=e.get(l);let h;return d===void 0?(h=new J_(o),e.set(l,[h])):c>=d.length?(h=new J_(o),d.push(h)):h=d[c],h}function r(){e=new WeakMap}return{get:i,dispose:r}}class $A extends No{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Jx,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class tb extends No{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const eb=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function ib(o,e,i){let r=new Bh;const l=new oe,c=new oe,d=new un,h=new $A({depthPacking:$x}),m=new tb,p={},_=i.maxTextureSize,S={[Oa]:Cn,[Cn]:Oa,[Yi]:Yi},x=new Qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new oe},radius:{value:4}},vertexShader:eb,fragmentShader:nb}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const R=new Ba;R.setAttribute("position",new hi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Rn(R,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ov;let v=this.type;this.render=function(I,N,O){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||I.length===0)return;const T=o.getRenderTarget(),E=o.getActiveCubeFace(),q=o.getActiveMipmapLevel(),st=o.state;st.setBlending(La),st.buffers.color.setClear(1,1,1,1),st.buffers.depth.setTest(!0),st.setScissorTest(!1);const V=v!==qi&&this.type===qi,ht=v===qi&&this.type!==qi;for(let dt=0,F=I.length;dt<F;dt++){const Z=I[dt],W=Z.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;l.copy(W.mapSize);const vt=W.getFrameExtents();if(l.multiply(vt),c.copy(W.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(c.x=Math.floor(_/vt.x),l.x=c.x*vt.x,W.mapSize.x=c.x),l.y>_&&(c.y=Math.floor(_/vt.y),l.y=c.y*vt.y,W.mapSize.y=c.y)),W.map===null||V===!0||ht===!0){const U=this.type!==qi?{minFilter:In,magFilter:In}:{};W.map!==null&&W.map.dispose(),W.map=new pr(l.x,l.y,U),W.map.texture.name=Z.name+".shadowMap",W.camera.updateProjectionMatrix()}o.setRenderTarget(W.map),o.clear();const ct=W.getViewportCount();for(let U=0;U<ct;U++){const $=W.getViewport(U);d.set(c.x*$.x,c.y*$.y,c.x*$.z,c.y*$.w),st.viewport(d),W.updateMatrices(Z,U),r=W.getFrustum(),z(N,O,W.camera,Z,this.type)}W.isPointLightShadow!==!0&&this.type===qi&&L(W,O),W.needsUpdate=!1}v=this.type,y.needsUpdate=!1,o.setRenderTarget(T,E,q)};function L(I,N){const O=e.update(C);x.defines.VSM_SAMPLES!==I.blurSamples&&(x.defines.VSM_SAMPLES=I.blurSamples,M.defines.VSM_SAMPLES=I.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new pr(l.x,l.y)),x.uniforms.shadow_pass.value=I.map.texture,x.uniforms.resolution.value=I.mapSize,x.uniforms.radius.value=I.radius,o.setRenderTarget(I.mapPass),o.clear(),o.renderBufferDirect(N,null,O,x,C,null),M.uniforms.shadow_pass.value=I.mapPass.texture,M.uniforms.resolution.value=I.mapSize,M.uniforms.radius.value=I.radius,o.setRenderTarget(I.map),o.clear(),o.renderBufferDirect(N,null,O,M,C,null)}function D(I,N,O,T){let E=null;const q=O.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(q!==void 0)E=q;else if(E=O.isPointLight===!0?m:h,o.localClippingEnabled&&N.clipShadows===!0&&Array.isArray(N.clippingPlanes)&&N.clippingPlanes.length!==0||N.displacementMap&&N.displacementScale!==0||N.alphaMap&&N.alphaTest>0||N.map&&N.alphaTest>0){const st=E.uuid,V=N.uuid;let ht=p[st];ht===void 0&&(ht={},p[st]=ht);let dt=ht[V];dt===void 0&&(dt=E.clone(),ht[V]=dt,N.addEventListener("dispose",J)),E=dt}if(E.visible=N.visible,E.wireframe=N.wireframe,T===qi?E.side=N.shadowSide!==null?N.shadowSide:N.side:E.side=N.shadowSide!==null?N.shadowSide:S[N.side],E.alphaMap=N.alphaMap,E.alphaTest=N.alphaTest,E.map=N.map,E.clipShadows=N.clipShadows,E.clippingPlanes=N.clippingPlanes,E.clipIntersection=N.clipIntersection,E.displacementMap=N.displacementMap,E.displacementScale=N.displacementScale,E.displacementBias=N.displacementBias,E.wireframeLinewidth=N.wireframeLinewidth,E.linewidth=N.linewidth,O.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const st=o.properties.get(E);st.light=O}return E}function z(I,N,O,T,E){if(I.visible===!1)return;if(I.layers.test(N.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&E===qi)&&(!I.frustumCulled||r.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,I.matrixWorld);const V=e.update(I),ht=I.material;if(Array.isArray(ht)){const dt=V.groups;for(let F=0,Z=dt.length;F<Z;F++){const W=dt[F],vt=ht[W.materialIndex];if(vt&&vt.visible){const ct=D(I,vt,T,E);I.onBeforeShadow(o,I,N,O,V,ct,W),o.renderBufferDirect(O,null,V,ct,I,W),I.onAfterShadow(o,I,N,O,V,ct,W)}}}else if(ht.visible){const dt=D(I,ht,T,E);I.onBeforeShadow(o,I,N,O,V,dt,null),o.renderBufferDirect(O,null,V,dt,I,null),I.onAfterShadow(o,I,N,O,V,dt,null)}}const st=I.children;for(let V=0,ht=st.length;V<ht;V++)z(st[V],N,O,T,E)}function J(I){I.target.removeEventListener("dispose",J);for(const O in p){const T=p[O],E=I.target.uuid;E in T&&(T[E].dispose(),delete T[E])}}}function ab(o){function e(){let X=!1;const Mt=new un;let mt=null;const Ct=new un(0,0,0,0);return{setMask:function(Ut){mt!==Ut&&!X&&(o.colorMask(Ut,Ut,Ut,Ut),mt=Ut)},setLocked:function(Ut){X=Ut},setClear:function(Ut,le,Ae,we,sn){sn===!0&&(Ut*=we,le*=we,Ae*=we),Mt.set(Ut,le,Ae,we),Ct.equals(Mt)===!1&&(o.clearColor(Ut,le,Ae,we),Ct.copy(Mt))},reset:function(){X=!1,mt=null,Ct.set(-1,0,0,0)}}}function i(){let X=!1,Mt=null,mt=null,Ct=null;return{setTest:function(Ut){Ut?Et(o.DEPTH_TEST):xt(o.DEPTH_TEST)},setMask:function(Ut){Mt!==Ut&&!X&&(o.depthMask(Ut),Mt=Ut)},setFunc:function(Ut){if(mt!==Ut){switch(Ut){case bx:o.depthFunc(o.NEVER);break;case Rx:o.depthFunc(o.ALWAYS);break;case Cx:o.depthFunc(o.LESS);break;case _u:o.depthFunc(o.LEQUAL);break;case wx:o.depthFunc(o.EQUAL);break;case Dx:o.depthFunc(o.GEQUAL);break;case Ux:o.depthFunc(o.GREATER);break;case Lx:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}mt=Ut}},setLocked:function(Ut){X=Ut},setClear:function(Ut){Ct!==Ut&&(o.clearDepth(Ut),Ct=Ut)},reset:function(){X=!1,Mt=null,mt=null,Ct=null}}}function r(){let X=!1,Mt=null,mt=null,Ct=null,Ut=null,le=null,Ae=null,we=null,sn=null;return{setTest:function(xe){X||(xe?Et(o.STENCIL_TEST):xt(o.STENCIL_TEST))},setMask:function(xe){Mt!==xe&&!X&&(o.stencilMask(xe),Mt=xe)},setFunc:function(xe,Dn,ke){(mt!==xe||Ct!==Dn||Ut!==ke)&&(o.stencilFunc(xe,Dn,ke),mt=xe,Ct=Dn,Ut=ke)},setOp:function(xe,Dn,ke){(le!==xe||Ae!==Dn||we!==ke)&&(o.stencilOp(xe,Dn,ke),le=xe,Ae=Dn,we=ke)},setLocked:function(xe){X=xe},setClear:function(xe){sn!==xe&&(o.clearStencil(xe),sn=xe)},reset:function(){X=!1,Mt=null,mt=null,Ct=null,Ut=null,le=null,Ae=null,we=null,sn=null}}}const l=new e,c=new i,d=new r,h=new WeakMap,m=new WeakMap;let p={},_={},S=new WeakMap,x=[],M=null,R=!1,C=null,y=null,v=null,L=null,D=null,z=null,J=null,I=new Se(0,0,0),N=0,O=!1,T=null,E=null,q=null,st=null,V=null;const ht=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let dt=!1,F=0;const Z=o.getParameter(o.VERSION);Z.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(Z)[1]),dt=F>=1):Z.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),dt=F>=2);let W=null,vt={};const ct=o.getParameter(o.SCISSOR_BOX),U=o.getParameter(o.VIEWPORT),$=new un().fromArray(ct),gt=new un().fromArray(U);function G(X,Mt,mt,Ct){const Ut=new Uint8Array(4),le=o.createTexture();o.bindTexture(X,le),o.texParameteri(X,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(X,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ae=0;Ae<mt;Ae++)X===o.TEXTURE_3D||X===o.TEXTURE_2D_ARRAY?o.texImage3D(Mt,0,o.RGBA,1,1,Ct,0,o.RGBA,o.UNSIGNED_BYTE,Ut):o.texImage2D(Mt+Ae,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Ut);return le}const ut={};ut[o.TEXTURE_2D]=G(o.TEXTURE_2D,o.TEXTURE_2D,1),ut[o.TEXTURE_CUBE_MAP]=G(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),ut[o.TEXTURE_2D_ARRAY]=G(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),ut[o.TEXTURE_3D]=G(o.TEXTURE_3D,o.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),d.setClear(0),Et(o.DEPTH_TEST),c.setFunc(_u),ie(!1),Qt(Ng),Et(o.CULL_FACE),ve(La);function Et(X){p[X]!==!0&&(o.enable(X),p[X]=!0)}function xt(X){p[X]!==!1&&(o.disable(X),p[X]=!1)}function kt(X,Mt){return _[X]!==Mt?(o.bindFramebuffer(X,Mt),_[X]=Mt,X===o.DRAW_FRAMEBUFFER&&(_[o.FRAMEBUFFER]=Mt),X===o.FRAMEBUFFER&&(_[o.DRAW_FRAMEBUFFER]=Mt),!0):!1}function Pt(X,Mt){let mt=x,Ct=!1;if(X){mt=S.get(Mt),mt===void 0&&(mt=[],S.set(Mt,mt));const Ut=X.textures;if(mt.length!==Ut.length||mt[0]!==o.COLOR_ATTACHMENT0){for(let le=0,Ae=Ut.length;le<Ae;le++)mt[le]=o.COLOR_ATTACHMENT0+le;mt.length=Ut.length,Ct=!0}}else mt[0]!==o.BACK&&(mt[0]=o.BACK,Ct=!0);Ct&&o.drawBuffers(mt)}function j(X){return M!==X?(o.useProgram(X),M=X,!0):!1}const ee={[cr]:o.FUNC_ADD,[ux]:o.FUNC_SUBTRACT,[cx]:o.FUNC_REVERSE_SUBTRACT};ee[fx]=o.MIN,ee[hx]=o.MAX;const Gt={[dx]:o.ZERO,[px]:o.ONE,[mx]:o.SRC_COLOR,[Th]:o.SRC_ALPHA,[yx]:o.SRC_ALPHA_SATURATE,[Sx]:o.DST_COLOR,[_x]:o.DST_ALPHA,[gx]:o.ONE_MINUS_SRC_COLOR,[Ah]:o.ONE_MINUS_SRC_ALPHA,[xx]:o.ONE_MINUS_DST_COLOR,[vx]:o.ONE_MINUS_DST_ALPHA,[Mx]:o.CONSTANT_COLOR,[Ex]:o.ONE_MINUS_CONSTANT_COLOR,[Tx]:o.CONSTANT_ALPHA,[Ax]:o.ONE_MINUS_CONSTANT_ALPHA};function ve(X,Mt,mt,Ct,Ut,le,Ae,we,sn,xe){if(X===La){R===!0&&(xt(o.BLEND),R=!1);return}if(R===!1&&(Et(o.BLEND),R=!0),X!==lx){if(X!==C||xe!==O){if((y!==cr||D!==cr)&&(o.blendEquation(o.FUNC_ADD),y=cr,D=cr),xe)switch(X){case gs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Og:o.blendFunc(o.ONE,o.ONE);break;case zg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Pg:o.blendFuncSeparate(o.ZERO,o.SRC_COLOR,o.ZERO,o.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}else switch(X){case gs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Og:o.blendFunc(o.SRC_ALPHA,o.ONE);break;case zg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Pg:o.blendFunc(o.ZERO,o.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}v=null,L=null,z=null,J=null,I.set(0,0,0),N=0,C=X,O=xe}return}Ut=Ut||Mt,le=le||mt,Ae=Ae||Ct,(Mt!==y||Ut!==D)&&(o.blendEquationSeparate(ee[Mt],ee[Ut]),y=Mt,D=Ut),(mt!==v||Ct!==L||le!==z||Ae!==J)&&(o.blendFuncSeparate(Gt[mt],Gt[Ct],Gt[le],Gt[Ae]),v=mt,L=Ct,z=le,J=Ae),(we.equals(I)===!1||sn!==N)&&(o.blendColor(we.r,we.g,we.b,sn),I.copy(we),N=sn),C=X,O=!1}function It(X,Mt){X.side===Yi?xt(o.CULL_FACE):Et(o.CULL_FACE);let mt=X.side===Cn;Mt&&(mt=!mt),ie(mt),X.blending===gs&&X.transparent===!1?ve(La):ve(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),c.setFunc(X.depthFunc),c.setTest(X.depthTest),c.setMask(X.depthWrite),l.setMask(X.colorWrite);const Ct=X.stencilWrite;d.setTest(Ct),Ct&&(d.setMask(X.stencilWriteMask),d.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),d.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),Ce(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?Et(o.SAMPLE_ALPHA_TO_COVERAGE):xt(o.SAMPLE_ALPHA_TO_COVERAGE)}function ie(X){T!==X&&(X?o.frontFace(o.CW):o.frontFace(o.CCW),T=X)}function Qt(X){X!==rx?(Et(o.CULL_FACE),X!==E&&(X===Ng?o.cullFace(o.BACK):X===sx?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):xt(o.CULL_FACE),E=X}function ae(X){X!==q&&(dt&&o.lineWidth(X),q=X)}function Ce(X,Mt,mt){X?(Et(o.POLYGON_OFFSET_FILL),(st!==Mt||V!==mt)&&(o.polygonOffset(Mt,mt),st=Mt,V=mt)):xt(o.POLYGON_OFFSET_FILL)}function P(X){X?Et(o.SCISSOR_TEST):xt(o.SCISSOR_TEST)}function b(X){X===void 0&&(X=o.TEXTURE0+ht-1),W!==X&&(o.activeTexture(X),W=X)}function ot(X,Mt,mt){mt===void 0&&(W===null?mt=o.TEXTURE0+ht-1:mt=W);let Ct=vt[mt];Ct===void 0&&(Ct={type:void 0,texture:void 0},vt[mt]=Ct),(Ct.type!==X||Ct.texture!==Mt)&&(W!==mt&&(o.activeTexture(mt),W=mt),o.bindTexture(X,Mt||ut[X]),Ct.type=X,Ct.texture=Mt)}function lt(){const X=vt[W];X!==void 0&&X.type!==void 0&&(o.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function yt(){try{o.compressedTexImage2D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function St(){try{o.compressedTexImage3D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Lt(){try{o.texSubImage2D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function At(){try{o.texSubImage3D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Tt(){try{o.compressedTexSubImage2D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function jt(){try{o.compressedTexSubImage3D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function bt(){try{o.texStorage2D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Ft(){try{o.texStorage3D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function fe(){try{o.texImage2D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Wt(){try{o.texImage3D.apply(o,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Dt(X){$.equals(X)===!1&&(o.scissor(X.x,X.y,X.z,X.w),$.copy(X))}function qt(X){gt.equals(X)===!1&&(o.viewport(X.x,X.y,X.z,X.w),gt.copy(X))}function $t(X,Mt){let mt=m.get(Mt);mt===void 0&&(mt=new WeakMap,m.set(Mt,mt));let Ct=mt.get(X);Ct===void 0&&(Ct=o.getUniformBlockIndex(Mt,X.name),mt.set(X,Ct))}function ge(X,Mt){const Ct=m.get(Mt).get(X);h.get(Mt)!==Ct&&(o.uniformBlockBinding(Mt,Ct,X.__bindingPointIndex),h.set(Mt,Ct))}function re(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),p={},W=null,vt={},_={},S=new WeakMap,x=[],M=null,R=!1,C=null,y=null,v=null,L=null,D=null,z=null,J=null,I=new Se(0,0,0),N=0,O=!1,T=null,E=null,q=null,st=null,V=null,$.set(0,0,o.canvas.width,o.canvas.height),gt.set(0,0,o.canvas.width,o.canvas.height),l.reset(),c.reset(),d.reset()}return{buffers:{color:l,depth:c,stencil:d},enable:Et,disable:xt,bindFramebuffer:kt,drawBuffers:Pt,useProgram:j,setBlending:ve,setMaterial:It,setFlipSided:ie,setCullFace:Qt,setLineWidth:ae,setPolygonOffset:Ce,setScissorTest:P,activeTexture:b,bindTexture:ot,unbindTexture:lt,compressedTexImage2D:yt,compressedTexImage3D:St,texImage2D:fe,texImage3D:Wt,updateUBOMapping:$t,uniformBlockBinding:ge,texStorage2D:bt,texStorage3D:Ft,texSubImage2D:Lt,texSubImage3D:At,compressedTexSubImage2D:Tt,compressedTexSubImage3D:jt,scissor:Dt,viewport:qt,reset:re}}function rb(o,e,i,r,l,c,d){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new oe,_=new WeakMap;let S;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function R(P,b){return M?new OffscreenCanvas(P,b):Mu("canvas")}function C(P,b,ot){let lt=1;const yt=Ce(P);if((yt.width>ot||yt.height>ot)&&(lt=ot/Math.max(yt.width,yt.height)),lt<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const St=Math.floor(lt*yt.width),Lt=Math.floor(lt*yt.height);S===void 0&&(S=R(St,Lt));const At=b?R(St,Lt):S;return At.width=St,At.height=Lt,At.getContext("2d").drawImage(P,0,0,St,Lt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+yt.width+"x"+yt.height+") to ("+St+"x"+Lt+")."),At}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+yt.width+"x"+yt.height+")."),P;return P}function y(P){return P.generateMipmaps&&P.minFilter!==In&&P.minFilter!==fi}function v(P){o.generateMipmap(P)}function L(P,b,ot,lt,yt=!1){if(P!==null){if(o[P]!==void 0)return o[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let St=b;if(b===o.RED&&(ot===o.FLOAT&&(St=o.R32F),ot===o.HALF_FLOAT&&(St=o.R16F),ot===o.UNSIGNED_BYTE&&(St=o.R8)),b===o.RED_INTEGER&&(ot===o.UNSIGNED_BYTE&&(St=o.R8UI),ot===o.UNSIGNED_SHORT&&(St=o.R16UI),ot===o.UNSIGNED_INT&&(St=o.R32UI),ot===o.BYTE&&(St=o.R8I),ot===o.SHORT&&(St=o.R16I),ot===o.INT&&(St=o.R32I)),b===o.RG&&(ot===o.FLOAT&&(St=o.RG32F),ot===o.HALF_FLOAT&&(St=o.RG16F),ot===o.UNSIGNED_BYTE&&(St=o.RG8)),b===o.RG_INTEGER&&(ot===o.UNSIGNED_BYTE&&(St=o.RG8UI),ot===o.UNSIGNED_SHORT&&(St=o.RG16UI),ot===o.UNSIGNED_INT&&(St=o.RG32UI),ot===o.BYTE&&(St=o.RG8I),ot===o.SHORT&&(St=o.RG16I),ot===o.INT&&(St=o.RG32I)),b===o.RGB&&ot===o.UNSIGNED_INT_5_9_9_9_REV&&(St=o.RGB9_E5),b===o.RGBA){const Lt=yt?vu:Ne.getTransfer(lt);ot===o.FLOAT&&(St=o.RGBA32F),ot===o.HALF_FLOAT&&(St=o.RGBA16F),ot===o.UNSIGNED_BYTE&&(St=Lt===Fe?o.SRGB8_ALPHA8:o.RGBA8),ot===o.UNSIGNED_SHORT_4_4_4_4&&(St=o.RGBA4),ot===o.UNSIGNED_SHORT_5_5_5_1&&(St=o.RGB5_A1)}return(St===o.R16F||St===o.R32F||St===o.RG16F||St===o.RG32F||St===o.RGBA16F||St===o.RGBA32F)&&e.get("EXT_color_buffer_float"),St}function D(P,b){return y(P)===!0||P.isFramebufferTexture&&P.minFilter!==In&&P.minFilter!==fi?Math.log2(Math.max(b.width,b.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?b.mipmaps.length:1}function z(P){const b=P.target;b.removeEventListener("dispose",z),I(b),b.isVideoTexture&&_.delete(b)}function J(P){const b=P.target;b.removeEventListener("dispose",J),O(b)}function I(P){const b=r.get(P);if(b.__webglInit===void 0)return;const ot=P.source,lt=x.get(ot);if(lt){const yt=lt[b.__cacheKey];yt.usedTimes--,yt.usedTimes===0&&N(P),Object.keys(lt).length===0&&x.delete(ot)}r.remove(P)}function N(P){const b=r.get(P);o.deleteTexture(b.__webglTexture);const ot=P.source,lt=x.get(ot);delete lt[b.__cacheKey],d.memory.textures--}function O(P){const b=r.get(P);if(P.depthTexture&&P.depthTexture.dispose(),P.isWebGLCubeRenderTarget)for(let lt=0;lt<6;lt++){if(Array.isArray(b.__webglFramebuffer[lt]))for(let yt=0;yt<b.__webglFramebuffer[lt].length;yt++)o.deleteFramebuffer(b.__webglFramebuffer[lt][yt]);else o.deleteFramebuffer(b.__webglFramebuffer[lt]);b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer[lt])}else{if(Array.isArray(b.__webglFramebuffer))for(let lt=0;lt<b.__webglFramebuffer.length;lt++)o.deleteFramebuffer(b.__webglFramebuffer[lt]);else o.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&o.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&o.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let lt=0;lt<b.__webglColorRenderbuffer.length;lt++)b.__webglColorRenderbuffer[lt]&&o.deleteRenderbuffer(b.__webglColorRenderbuffer[lt]);b.__webglDepthRenderbuffer&&o.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const ot=P.textures;for(let lt=0,yt=ot.length;lt<yt;lt++){const St=r.get(ot[lt]);St.__webglTexture&&(o.deleteTexture(St.__webglTexture),d.memory.textures--),r.remove(ot[lt])}r.remove(P)}let T=0;function E(){T=0}function q(){const P=T;return P>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l.maxTextures),T+=1,P}function st(P){const b=[];return b.push(P.wrapS),b.push(P.wrapT),b.push(P.wrapR||0),b.push(P.magFilter),b.push(P.minFilter),b.push(P.anisotropy),b.push(P.internalFormat),b.push(P.format),b.push(P.type),b.push(P.generateMipmaps),b.push(P.premultiplyAlpha),b.push(P.flipY),b.push(P.unpackAlignment),b.push(P.colorSpace),b.join()}function V(P,b){const ot=r.get(P);if(P.isVideoTexture&&Qt(P),P.isRenderTargetTexture===!1&&P.version>0&&ot.__version!==P.version){const lt=P.image;if(lt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(lt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(ot,P,b);return}}i.bindTexture(o.TEXTURE_2D,ot.__webglTexture,o.TEXTURE0+b)}function ht(P,b){const ot=r.get(P);if(P.version>0&&ot.__version!==P.version){$(ot,P,b);return}i.bindTexture(o.TEXTURE_2D_ARRAY,ot.__webglTexture,o.TEXTURE0+b)}function dt(P,b){const ot=r.get(P);if(P.version>0&&ot.__version!==P.version){$(ot,P,b);return}i.bindTexture(o.TEXTURE_3D,ot.__webglTexture,o.TEXTURE0+b)}function F(P,b){const ot=r.get(P);if(P.version>0&&ot.__version!==P.version){gt(ot,P,b);return}i.bindTexture(o.TEXTURE_CUBE_MAP,ot.__webglTexture,o.TEXTURE0+b)}const Z={[Ch]:o.REPEAT,[hr]:o.CLAMP_TO_EDGE,[wh]:o.MIRRORED_REPEAT},W={[In]:o.NEAREST,[Vx]:o.NEAREST_MIPMAP_NEAREST,[kl]:o.NEAREST_MIPMAP_LINEAR,[fi]:o.LINEAR,[Vf]:o.LINEAR_MIPMAP_NEAREST,[dr]:o.LINEAR_MIPMAP_LINEAR},vt={[ey]:o.NEVER,[oy]:o.ALWAYS,[ny]:o.LESS,[Sv]:o.LEQUAL,[iy]:o.EQUAL,[sy]:o.GEQUAL,[ay]:o.GREATER,[ry]:o.NOTEQUAL};function ct(P,b){if(b.type===ji&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===fi||b.magFilter===Vf||b.magFilter===kl||b.magFilter===dr||b.minFilter===fi||b.minFilter===Vf||b.minFilter===kl||b.minFilter===dr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(P,o.TEXTURE_WRAP_S,Z[b.wrapS]),o.texParameteri(P,o.TEXTURE_WRAP_T,Z[b.wrapT]),(P===o.TEXTURE_3D||P===o.TEXTURE_2D_ARRAY)&&o.texParameteri(P,o.TEXTURE_WRAP_R,Z[b.wrapR]),o.texParameteri(P,o.TEXTURE_MAG_FILTER,W[b.magFilter]),o.texParameteri(P,o.TEXTURE_MIN_FILTER,W[b.minFilter]),b.compareFunction&&(o.texParameteri(P,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(P,o.TEXTURE_COMPARE_FUNC,vt[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===In||b.minFilter!==kl&&b.minFilter!==dr||b.type===ji&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||r.get(b).__currentAnisotropy){const ot=e.get("EXT_texture_filter_anisotropic");o.texParameterf(P,ot.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,l.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy}}}function U(P,b){let ot=!1;P.__webglInit===void 0&&(P.__webglInit=!0,b.addEventListener("dispose",z));const lt=b.source;let yt=x.get(lt);yt===void 0&&(yt={},x.set(lt,yt));const St=st(b);if(St!==P.__cacheKey){yt[St]===void 0&&(yt[St]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,ot=!0),yt[St].usedTimes++;const Lt=yt[P.__cacheKey];Lt!==void 0&&(yt[P.__cacheKey].usedTimes--,Lt.usedTimes===0&&N(b)),P.__cacheKey=St,P.__webglTexture=yt[St].texture}return ot}function $(P,b,ot){let lt=o.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(lt=o.TEXTURE_2D_ARRAY),b.isData3DTexture&&(lt=o.TEXTURE_3D);const yt=U(P,b),St=b.source;i.bindTexture(lt,P.__webglTexture,o.TEXTURE0+ot);const Lt=r.get(St);if(St.version!==Lt.__version||yt===!0){i.activeTexture(o.TEXTURE0+ot);const At=Ne.getPrimaries(Ne.workingColorSpace),Tt=b.colorSpace===Ua?null:Ne.getPrimaries(b.colorSpace),jt=b.colorSpace===Ua||At===Tt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,jt);let bt=C(b.image,!1,l.maxTextureSize);bt=ae(b,bt);const Ft=c.convert(b.format,b.colorSpace),fe=c.convert(b.type);let Wt=L(b.internalFormat,Ft,fe,b.colorSpace,b.isVideoTexture);ct(lt,b);let Dt;const qt=b.mipmaps,$t=b.isVideoTexture!==!0,ge=Lt.__version===void 0||yt===!0,re=St.dataReady,X=D(b,bt);if(b.isDepthTexture)Wt=o.DEPTH_COMPONENT16,b.type===ji?Wt=o.DEPTH_COMPONENT32F:b.type===ys?Wt=o.DEPTH_COMPONENT24:b.type===Do&&(Wt=o.DEPTH24_STENCIL8),ge&&($t?i.texStorage2D(o.TEXTURE_2D,1,Wt,bt.width,bt.height):i.texImage2D(o.TEXTURE_2D,0,Wt,bt.width,bt.height,0,Ft,fe,null));else if(b.isDataTexture)if(qt.length>0){$t&&ge&&i.texStorage2D(o.TEXTURE_2D,X,Wt,qt[0].width,qt[0].height);for(let Mt=0,mt=qt.length;Mt<mt;Mt++)Dt=qt[Mt],$t?re&&i.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Ft,fe,Dt.data):i.texImage2D(o.TEXTURE_2D,Mt,Wt,Dt.width,Dt.height,0,Ft,fe,Dt.data);b.generateMipmaps=!1}else $t?(ge&&i.texStorage2D(o.TEXTURE_2D,X,Wt,bt.width,bt.height),re&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,bt.width,bt.height,Ft,fe,bt.data)):i.texImage2D(o.TEXTURE_2D,0,Wt,bt.width,bt.height,0,Ft,fe,bt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){$t&&ge&&i.texStorage3D(o.TEXTURE_2D_ARRAY,X,Wt,qt[0].width,qt[0].height,bt.depth);for(let Mt=0,mt=qt.length;Mt<mt;Mt++)Dt=qt[Mt],b.format!==Mi?Ft!==null?$t?re&&i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Dt.width,Dt.height,bt.depth,Ft,Dt.data,0,0):i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Mt,Wt,Dt.width,Dt.height,bt.depth,0,Dt.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):$t?re&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Dt.width,Dt.height,bt.depth,Ft,fe,Dt.data):i.texImage3D(o.TEXTURE_2D_ARRAY,Mt,Wt,Dt.width,Dt.height,bt.depth,0,Ft,fe,Dt.data)}else{$t&&ge&&i.texStorage2D(o.TEXTURE_2D,X,Wt,qt[0].width,qt[0].height);for(let Mt=0,mt=qt.length;Mt<mt;Mt++)Dt=qt[Mt],b.format!==Mi?Ft!==null?$t?re&&i.compressedTexSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Ft,Dt.data):i.compressedTexImage2D(o.TEXTURE_2D,Mt,Wt,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):$t?re&&i.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Ft,fe,Dt.data):i.texImage2D(o.TEXTURE_2D,Mt,Wt,Dt.width,Dt.height,0,Ft,fe,Dt.data)}else if(b.isDataArrayTexture)$t?(ge&&i.texStorage3D(o.TEXTURE_2D_ARRAY,X,Wt,bt.width,bt.height,bt.depth),re&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,Ft,fe,bt.data)):i.texImage3D(o.TEXTURE_2D_ARRAY,0,Wt,bt.width,bt.height,bt.depth,0,Ft,fe,bt.data);else if(b.isData3DTexture)$t?(ge&&i.texStorage3D(o.TEXTURE_3D,X,Wt,bt.width,bt.height,bt.depth),re&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,Ft,fe,bt.data)):i.texImage3D(o.TEXTURE_3D,0,Wt,bt.width,bt.height,bt.depth,0,Ft,fe,bt.data);else if(b.isFramebufferTexture){if(ge)if($t)i.texStorage2D(o.TEXTURE_2D,X,Wt,bt.width,bt.height);else{let Mt=bt.width,mt=bt.height;for(let Ct=0;Ct<X;Ct++)i.texImage2D(o.TEXTURE_2D,Ct,Wt,Mt,mt,0,Ft,fe,null),Mt>>=1,mt>>=1}}else if(qt.length>0){if($t&&ge){const Mt=Ce(qt[0]);i.texStorage2D(o.TEXTURE_2D,X,Wt,Mt.width,Mt.height)}for(let Mt=0,mt=qt.length;Mt<mt;Mt++)Dt=qt[Mt],$t?re&&i.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ft,fe,Dt):i.texImage2D(o.TEXTURE_2D,Mt,Wt,Ft,fe,Dt);b.generateMipmaps=!1}else if($t){if(ge){const Mt=Ce(bt);i.texStorage2D(o.TEXTURE_2D,X,Wt,Mt.width,Mt.height)}re&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Ft,fe,bt)}else i.texImage2D(o.TEXTURE_2D,0,Wt,Ft,fe,bt);y(b)&&v(lt),Lt.__version=St.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function gt(P,b,ot){if(b.image.length!==6)return;const lt=U(P,b),yt=b.source;i.bindTexture(o.TEXTURE_CUBE_MAP,P.__webglTexture,o.TEXTURE0+ot);const St=r.get(yt);if(yt.version!==St.__version||lt===!0){i.activeTexture(o.TEXTURE0+ot);const Lt=Ne.getPrimaries(Ne.workingColorSpace),At=b.colorSpace===Ua?null:Ne.getPrimaries(b.colorSpace),Tt=b.colorSpace===Ua||Lt===At?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,b.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,b.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Tt);const jt=b.isCompressedTexture||b.image[0].isCompressedTexture,bt=b.image[0]&&b.image[0].isDataTexture,Ft=[];for(let mt=0;mt<6;mt++)!jt&&!bt?Ft[mt]=C(b.image[mt],!0,l.maxCubemapSize):Ft[mt]=bt?b.image[mt].image:b.image[mt],Ft[mt]=ae(b,Ft[mt]);const fe=Ft[0],Wt=c.convert(b.format,b.colorSpace),Dt=c.convert(b.type),qt=L(b.internalFormat,Wt,Dt,b.colorSpace),$t=b.isVideoTexture!==!0,ge=St.__version===void 0||lt===!0,re=yt.dataReady;let X=D(b,fe);ct(o.TEXTURE_CUBE_MAP,b);let Mt;if(jt){$t&&ge&&i.texStorage2D(o.TEXTURE_CUBE_MAP,X,qt,fe.width,fe.height);for(let mt=0;mt<6;mt++){Mt=Ft[mt].mipmaps;for(let Ct=0;Ct<Mt.length;Ct++){const Ut=Mt[Ct];b.format!==Mi?Wt!==null?$t?re&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct,0,0,Ut.width,Ut.height,Wt,Ut.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct,qt,Ut.width,Ut.height,0,Ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):$t?re&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct,0,0,Ut.width,Ut.height,Wt,Dt,Ut.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct,qt,Ut.width,Ut.height,0,Wt,Dt,Ut.data)}}}else{if(Mt=b.mipmaps,$t&&ge){Mt.length>0&&X++;const mt=Ce(Ft[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,X,qt,mt.width,mt.height)}for(let mt=0;mt<6;mt++)if(bt){$t?re&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,0,0,Ft[mt].width,Ft[mt].height,Wt,Dt,Ft[mt].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,qt,Ft[mt].width,Ft[mt].height,0,Wt,Dt,Ft[mt].data);for(let Ct=0;Ct<Mt.length;Ct++){const le=Mt[Ct].image[mt].image;$t?re&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct+1,0,0,le.width,le.height,Wt,Dt,le.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct+1,qt,le.width,le.height,0,Wt,Dt,le.data)}}else{$t?re&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,0,0,Wt,Dt,Ft[mt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,qt,Wt,Dt,Ft[mt]);for(let Ct=0;Ct<Mt.length;Ct++){const Ut=Mt[Ct];$t?re&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct+1,0,0,Wt,Dt,Ut.image[mt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ct+1,qt,Wt,Dt,Ut.image[mt])}}}y(b)&&v(o.TEXTURE_CUBE_MAP),St.__version=yt.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function G(P,b,ot,lt,yt,St){const Lt=c.convert(ot.format,ot.colorSpace),At=c.convert(ot.type),Tt=L(ot.internalFormat,Lt,At,ot.colorSpace);if(!r.get(b).__hasExternalTextures){const bt=Math.max(1,b.width>>St),Ft=Math.max(1,b.height>>St);yt===o.TEXTURE_3D||yt===o.TEXTURE_2D_ARRAY?i.texImage3D(yt,St,Tt,bt,Ft,b.depth,0,Lt,At,null):i.texImage2D(yt,St,Tt,bt,Ft,0,Lt,At,null)}i.bindFramebuffer(o.FRAMEBUFFER,P),ie(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,lt,yt,r.get(ot).__webglTexture,0,It(b)):(yt===o.TEXTURE_2D||yt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&yt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,lt,yt,r.get(ot).__webglTexture,St),i.bindFramebuffer(o.FRAMEBUFFER,null)}function ut(P,b,ot){if(o.bindRenderbuffer(o.RENDERBUFFER,P),b.depthBuffer&&!b.stencilBuffer){let lt=o.DEPTH_COMPONENT24;if(ot||ie(b)){const yt=b.depthTexture;yt&&yt.isDepthTexture&&(yt.type===ji?lt=o.DEPTH_COMPONENT32F:yt.type===ys&&(lt=o.DEPTH_COMPONENT24));const St=It(b);ie(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,St,lt,b.width,b.height):o.renderbufferStorageMultisample(o.RENDERBUFFER,St,lt,b.width,b.height)}else o.renderbufferStorage(o.RENDERBUFFER,lt,b.width,b.height);o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,P)}else if(b.depthBuffer&&b.stencilBuffer){const lt=It(b);ot&&ie(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,lt,o.DEPTH24_STENCIL8,b.width,b.height):ie(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,lt,o.DEPTH24_STENCIL8,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_STENCIL,b.width,b.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.RENDERBUFFER,P)}else{const lt=b.textures;for(let yt=0;yt<lt.length;yt++){const St=lt[yt],Lt=c.convert(St.format,St.colorSpace),At=c.convert(St.type),Tt=L(St.internalFormat,Lt,At,St.colorSpace),jt=It(b);ot&&ie(b)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,jt,Tt,b.width,b.height):ie(b)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,jt,Tt,b.width,b.height):o.renderbufferStorage(o.RENDERBUFFER,Tt,b.width,b.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Et(P,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,P),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(b.depthTexture).__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),V(b.depthTexture,0);const lt=r.get(b.depthTexture).__webglTexture,yt=It(b);if(b.depthTexture.format===_s)ie(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,lt,0,yt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,lt,0);else if(b.depthTexture.format===wo)ie(b)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,lt,0,yt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,lt,0);else throw new Error("Unknown depthTexture format")}function xt(P){const b=r.get(P),ot=P.isWebGLCubeRenderTarget===!0;if(P.depthTexture&&!b.__autoAllocateDepthBuffer){if(ot)throw new Error("target.depthTexture not supported in Cube render targets");Et(b.__webglFramebuffer,P)}else if(ot){b.__webglDepthbuffer=[];for(let lt=0;lt<6;lt++)i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer[lt]),b.__webglDepthbuffer[lt]=o.createRenderbuffer(),ut(b.__webglDepthbuffer[lt],P,!1)}else i.bindFramebuffer(o.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer=o.createRenderbuffer(),ut(b.__webglDepthbuffer,P,!1);i.bindFramebuffer(o.FRAMEBUFFER,null)}function kt(P,b,ot){const lt=r.get(P);b!==void 0&&G(lt.__webglFramebuffer,P,P.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),ot!==void 0&&xt(P)}function Pt(P){const b=P.texture,ot=r.get(P),lt=r.get(b);P.addEventListener("dispose",J);const yt=P.textures,St=P.isWebGLCubeRenderTarget===!0,Lt=yt.length>1;if(Lt||(lt.__webglTexture===void 0&&(lt.__webglTexture=o.createTexture()),lt.__version=b.version,d.memory.textures++),St){ot.__webglFramebuffer=[];for(let At=0;At<6;At++)if(b.mipmaps&&b.mipmaps.length>0){ot.__webglFramebuffer[At]=[];for(let Tt=0;Tt<b.mipmaps.length;Tt++)ot.__webglFramebuffer[At][Tt]=o.createFramebuffer()}else ot.__webglFramebuffer[At]=o.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){ot.__webglFramebuffer=[];for(let At=0;At<b.mipmaps.length;At++)ot.__webglFramebuffer[At]=o.createFramebuffer()}else ot.__webglFramebuffer=o.createFramebuffer();if(Lt)for(let At=0,Tt=yt.length;At<Tt;At++){const jt=r.get(yt[At]);jt.__webglTexture===void 0&&(jt.__webglTexture=o.createTexture(),d.memory.textures++)}if(P.samples>0&&ie(P)===!1){ot.__webglMultisampledFramebuffer=o.createFramebuffer(),ot.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,ot.__webglMultisampledFramebuffer);for(let At=0;At<yt.length;At++){const Tt=yt[At];ot.__webglColorRenderbuffer[At]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,ot.__webglColorRenderbuffer[At]);const jt=c.convert(Tt.format,Tt.colorSpace),bt=c.convert(Tt.type),Ft=L(Tt.internalFormat,jt,bt,Tt.colorSpace,P.isXRRenderTarget===!0),fe=It(P);o.renderbufferStorageMultisample(o.RENDERBUFFER,fe,Ft,P.width,P.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+At,o.RENDERBUFFER,ot.__webglColorRenderbuffer[At])}o.bindRenderbuffer(o.RENDERBUFFER,null),P.depthBuffer&&(ot.__webglDepthRenderbuffer=o.createRenderbuffer(),ut(ot.__webglDepthRenderbuffer,P,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(St){i.bindTexture(o.TEXTURE_CUBE_MAP,lt.__webglTexture),ct(o.TEXTURE_CUBE_MAP,b);for(let At=0;At<6;At++)if(b.mipmaps&&b.mipmaps.length>0)for(let Tt=0;Tt<b.mipmaps.length;Tt++)G(ot.__webglFramebuffer[At][Tt],P,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+At,Tt);else G(ot.__webglFramebuffer[At],P,b,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0);y(b)&&v(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Lt){for(let At=0,Tt=yt.length;At<Tt;At++){const jt=yt[At],bt=r.get(jt);i.bindTexture(o.TEXTURE_2D,bt.__webglTexture),ct(o.TEXTURE_2D,jt),G(ot.__webglFramebuffer,P,jt,o.COLOR_ATTACHMENT0+At,o.TEXTURE_2D,0),y(jt)&&v(o.TEXTURE_2D)}i.unbindTexture()}else{let At=o.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(At=P.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(At,lt.__webglTexture),ct(At,b),b.mipmaps&&b.mipmaps.length>0)for(let Tt=0;Tt<b.mipmaps.length;Tt++)G(ot.__webglFramebuffer[Tt],P,b,o.COLOR_ATTACHMENT0,At,Tt);else G(ot.__webglFramebuffer,P,b,o.COLOR_ATTACHMENT0,At,0);y(b)&&v(At),i.unbindTexture()}P.depthBuffer&&xt(P)}function j(P){const b=P.textures;for(let ot=0,lt=b.length;ot<lt;ot++){const yt=b[ot];if(y(yt)){const St=P.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:o.TEXTURE_2D,Lt=r.get(yt).__webglTexture;i.bindTexture(St,Lt),v(St),i.unbindTexture()}}}const ee=[],Gt=[];function ve(P){if(P.samples>0){if(ie(P)===!1){const b=P.textures,ot=P.width,lt=P.height;let yt=o.COLOR_BUFFER_BIT;const St=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Lt=r.get(P),At=b.length>1;if(At)for(let Tt=0;Tt<b.length;Tt++)i.bindFramebuffer(o.FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Tt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Lt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Tt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Lt.__webglFramebuffer);for(let Tt=0;Tt<b.length;Tt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(yt|=o.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(yt|=o.STENCIL_BUFFER_BIT)),At){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Lt.__webglColorRenderbuffer[Tt]);const jt=r.get(b[Tt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,jt,0)}o.blitFramebuffer(0,0,ot,lt,0,0,ot,lt,yt,o.NEAREST),m===!0&&(ee.length=0,Gt.length=0,ee.push(o.COLOR_ATTACHMENT0+Tt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(ee.push(St),Gt.push(St),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,Gt)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,ee))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),At)for(let Tt=0;Tt<b.length;Tt++){i.bindFramebuffer(o.FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Tt,o.RENDERBUFFER,Lt.__webglColorRenderbuffer[Tt]);const jt=r.get(b[Tt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Lt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Tt,o.TEXTURE_2D,jt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Lt.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&m){const b=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[b])}}}function It(P){return Math.min(l.maxSamples,P.samples)}function ie(P){const b=r.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Qt(P){const b=d.render.frame;_.get(P)!==b&&(_.set(P,b),P.update())}function ae(P,b){const ot=P.colorSpace,lt=P.format,yt=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||ot!==Pa&&ot!==Ua&&(Ne.getTransfer(ot)===Fe?(lt!==Mi||yt!==za)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",ot)),b}function Ce(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(p.width=P.naturalWidth||P.width,p.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(p.width=P.displayWidth,p.height=P.displayHeight):(p.width=P.width,p.height=P.height),p}this.allocateTextureUnit=q,this.resetTextureUnits=E,this.setTexture2D=V,this.setTexture2DArray=ht,this.setTexture3D=dt,this.setTextureCube=F,this.rebindTextures=kt,this.setupRenderTarget=Pt,this.updateRenderTargetMipmap=j,this.updateMultisampleRenderTarget=ve,this.setupDepthRenderbuffer=xt,this.setupFrameBufferTexture=G,this.useMultisampledRTT=ie}function sb(o,e){function i(r,l=Ua){let c;const d=Ne.getTransfer(l);if(r===za)return o.UNSIGNED_BYTE;if(r===hv)return o.UNSIGNED_SHORT_4_4_4_4;if(r===dv)return o.UNSIGNED_SHORT_5_5_5_1;if(r===Wx)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===Xx)return o.BYTE;if(r===kx)return o.SHORT;if(r===cv)return o.UNSIGNED_SHORT;if(r===fv)return o.INT;if(r===ys)return o.UNSIGNED_INT;if(r===ji)return o.FLOAT;if(r===Tu)return o.HALF_FLOAT;if(r===qx)return o.ALPHA;if(r===Yx)return o.RGB;if(r===Mi)return o.RGBA;if(r===jx)return o.LUMINANCE;if(r===Zx)return o.LUMINANCE_ALPHA;if(r===_s)return o.DEPTH_COMPONENT;if(r===wo)return o.DEPTH_STENCIL;if(r===pv)return o.RED;if(r===mv)return o.RED_INTEGER;if(r===Kx)return o.RG;if(r===gv)return o.RG_INTEGER;if(r===_v)return o.RGBA_INTEGER;if(r===Xf||r===kf||r===Wf||r===qf)if(d===Fe)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(r===Xf)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===kf)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Wf)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===qf)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(r===Xf)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===kf)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Wf)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===qf)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Bg||r===Ig||r===Fg||r===Hg)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(r===Bg)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Ig)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Fg)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Hg)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Gg||r===Vg||r===Xg)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(r===Gg||r===Vg)return d===Fe?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(r===Xg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===kg||r===Wg||r===qg||r===Yg||r===jg||r===Zg||r===Kg||r===Qg||r===Jg||r===$g||r===t_||r===e_||r===n_||r===i_)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(r===kg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Wg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===qg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Yg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===jg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Zg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Kg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Qg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Jg)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===$g)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===t_)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===e_)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===n_)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===i_)return d===Fe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Yf||r===a_||r===r_)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(r===Yf)return d===Fe?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===a_)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===r_)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Qx||r===s_||r===o_||r===l_)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(r===Yf)return c.COMPRESSED_RED_RGTC1_EXT;if(r===s_)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===o_)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===l_)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Do?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}class ob extends ai{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class hu extends xn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const lb={type:"move"};class yh{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new hu,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new hu,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new tt,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new tt),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new hu,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new tt,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new tt),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const i=this._hand;if(i)for(const r of e.hand.values())this._getHandJoint(i,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,i,r){let l=null,c=null,d=null;const h=this._targetRay,m=this._grip,p=this._hand;if(e&&i.session.visibilityState!=="visible-blurred"){if(p&&e.hand){d=!0;for(const C of e.hand.values()){const y=i.getJointPose(C,r),v=this._getHandJoint(p,C);y!==null&&(v.matrix.fromArray(y.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=y.radius),v.visible=y!==null}const _=p.joints["index-finger-tip"],S=p.joints["thumb-tip"],x=_.position.distanceTo(S.position),M=.02,R=.005;p.inputState.pinching&&x>M+R?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&x<=M-R&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else m!==null&&e.gripSpace&&(c=i.getPose(e.gripSpace,r),c!==null&&(m.matrix.fromArray(c.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,c.linearVelocity?(m.hasLinearVelocity=!0,m.linearVelocity.copy(c.linearVelocity)):m.hasLinearVelocity=!1,c.angularVelocity?(m.hasAngularVelocity=!0,m.angularVelocity.copy(c.angularVelocity)):m.hasAngularVelocity=!1));h!==null&&(l=i.getPose(e.targetRaySpace,r),l===null&&c!==null&&(l=c),l!==null&&(h.matrix.fromArray(l.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,l.linearVelocity?(h.hasLinearVelocity=!0,h.linearVelocity.copy(l.linearVelocity)):h.hasLinearVelocity=!1,l.angularVelocity?(h.hasAngularVelocity=!0,h.angularVelocity.copy(l.angularVelocity)):h.hasAngularVelocity=!1,this.dispatchEvent(lb)))}return h!==null&&(h.visible=l!==null),m!==null&&(m.visible=c!==null),p!==null&&(p.visible=d!==null),this}_getHandJoint(e,i){if(e.joints[i.jointName]===void 0){const r=new hu;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[i.jointName]=r,e.add(r)}return e.joints[i.jointName]}}const ub=`
void main() {
...
}`;class fb{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i,r){if(this.texture===null){const l=new wn,c=e.properties.get(l);c.__webglTexture=i.texture,(i.depthNear!=r.depthNear||i.depthFar!=r.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}render(e,i){if(this.texture!==null){if(this.mesh===null){const r=i.cameras[0].viewport,l=new Qi({vertexShader:ub,fragmentShader:cb,uniforms:{depthColor:{value:this.texture},depthWidth:{value:r.z},depthHeight:{value:r.w}}});this.mesh=new Rn(new bu(20,20),l)}e.render(this.mesh,i)}}reset(){this.texture=null,this.mesh=null}}class hb extends Es{constructor(e,i){super();const r=this;let l=null,c=1,d=null,h="local-floor",m=1,p=null,_=null,S=null,x=null,M=null,R=null;const C=new fb,y=i.getContextAttributes();let v=null,L=null;const D=[],z=[],J=new oe;let I=null;const N=new ai;N.layers.enable(1),N.viewport=new un;const O=new ai;O.layers.enable(2),O.viewport=new un;const T=[N,O],E=new ob;E.layers.enable(1),E.layers.enable(2);let q=null,st=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(G){let ut=D[G];return ut===void 0&&(ut=new yh,D[G]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(G){let ut=D[G];return ut===void 0&&(ut=new yh,D[G]=ut),ut.getGripSpace()},this.getHand=function(G){let ut=D[G];return ut===void 0&&(ut=new yh,D[G]=ut),ut.getHandSpace()};function V(G){const ut=z.indexOf(G.inputSource);if(ut===-1)return;const Et=D[ut];Et!==void 0&&(Et.update(G.inputSource,G.frame,p||d),Et.dispatchEvent({type:G.type,data:G.inputSource}))}function ht(){l.removeEventListener("select",V),l.removeEventListener("selectstart",V),l.removeEventListener("selectend",V),l.removeEventListener("squeeze",V),l.removeEventListener("squeezestart",V),l.removeEventListener("squeezeend",V),l.removeEventListener("end",ht),l.removeEventListener("inputsourceschange",dt);for(let G=0;G<D.length;G++){const ut=z[G];ut!==null&&(z[G]=null,D[G].disconnect(ut))}q=null,st=null,C.reset(),e.setRenderTarget(v),M=null,x=null,S=null,l=null,L=null,gt.stop(),r.isPresenting=!1,e.setPixelRatio(I),e.setSize(J.width,J.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(G){c=G,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(G){h=G,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(G){p=G},this.getBaseLayer=function(){return x!==null?x:M},this.getBinding=function(){return S},this.getFrame=function(){return R},this.getSession=function(){return l},this.setSession=async function(G){if(l=G,l!==null){if(v=e.getRenderTarget(),l.addEventListener("select",V),l.addEventListener("selectstart",V),l.addEventListener("selectend",V),l.addEventListener("squeeze",V),l.addEventListener("squeezestart",V),l.addEventListener("squeezeend",V),l.addEventListener("end",ht),l.addEventListener("inputsourceschange",dt),y.xrCompatible!==!0&&await i.makeXRCompatible(),I=e.getPixelRatio(),e.getSize(J),l.renderState.layers===void 0){const ut={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:c};M=new XRWebGLLayer(l,i,ut),l.updateRenderState({baseLayer:M}),e.setPixelRatio(1),e.setSize(M.framebufferWidth,M.framebufferHeight,!1),L=new pr(M.framebufferWidth,M.framebufferHeight,{format:Mi,type:za,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil})}else{let ut=null,Et=null,xt=null;y.depth&&(xt=y.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,ut=y.stencil?wo:_s,Et=y.stencil?Do:ys);const kt={colorFormat:i.RGBA8,depthFormat:xt,scaleFactor:c};S=new XRWebGLBinding(l,i),x=S.createProjectionLayer(kt),l.updateRenderState({layers:[x]}),e.setPixelRatio(1),e.setSize(x.textureWidth,x.textureHeight,!1),L=new pr(x.textureWidth,x.textureHeight,{format:Mi,type:za,depthTexture:new Ov(x.textureWidth,x.textureHeight,Et,void 0,void 0,void 0,void 0,void 0,void 0,ut),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),gt.setContext(l),gt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode};function dt(G){for(let ut=0;ut<G.removed.length;ut++){const Et=G.removed[ut],xt=z.indexOf(Et);xt>=0&&(z[xt]=null,D[xt].disconnect(Et))}for(let ut=0;ut<G.added.length;ut++){const Et=G.added[ut];let xt=z.indexOf(Et);if(xt===-1){for(let Pt=0;Pt<D.length;Pt++)if(Pt>=z.length){z.push(Et),xt=Pt;break}else if(z[Pt]===null){z[Pt]=Et,xt=Pt;break}if(xt===-1)break}const kt=D[xt];kt&&kt.connect(Et)}}const F=new tt,Z=new tt;function W(G,ut,Et){F.setFromMatrixPosition(ut.matrixWorld),Z.setFromMatrixPosition(Et.matrixWorld);const xt=F.distanceTo(Z),kt=ut.projectionMatrix.elements,Pt=Et.projectionMatrix.elements,j=kt[14]/(kt[10]-1),ee=kt[14]/(kt[10]+1),Gt=(kt[9]+1)/kt[5],ve=(kt[9]-1)/kt[5],It=(kt[8]-1)/kt[0],ie=(Pt[8]+1)/Pt[0],Qt=j*It,ae=j*ie,Ce=xt/(-It+ie),P=Ce*-It;ut.matrixWorld.decompose(G.position,G.quaternion,G.scale),G.translateX(P),G.translateZ(Ce),G.matrixWorld.compose(G.position,G.quaternion,G.scale),G.matrixWorldInverse.copy(G.matrixWorld).invert();const b=j+Ce,ot=ee+Ce,lt=Qt-P,yt=ae+(xt-P),St=Gt*ee/ot*b,Lt=ve*ee/ot*b;G.projectionMatrix.makePerspective(lt,yt,St,Lt,b,ot),G.projectionMatrixInverse.copy(G.projectionMatrix).invert()}function vt(G,ut){ut===null?G.matrixWorld.copy(G.matrix):G.matrixWorld.multiplyMatrices(ut.matrixWorld,G.matrix),G.matrixWorldInverse.copy(G.matrixWorld).invert()}this.updateCamera=function(G){if(l===null)return;C.texture!==null&&(G.near=C.depthNear,G.far=C.depthFar),E.near=O.near=N.near=G.near,E.far=O.far=N.far=G.far,(q!==E.near||st!==E.far)&&(l.updateRenderState({depthNear:E.near,depthFar:E.far}),q=E.near,st=E.far,N.near=q,N.far=st,O.near=q,O.far=st,N.updateProjectionMatrix(),O.updateProjectionMatrix(),G.updateProjectionMatrix());const ut=G.parent,Et=E.cameras;vt(E,ut);for(let xt=0;xt<Et.length;xt++)vt(Et[xt],ut);Et.length===2?W(E,N,O):E.projectionMatrix.copy(N.projectionMatrix),ct(G,E,ut)};function ct(G,ut,Et){Et===null?G.matrix.copy(ut.matrixWorld):(G.matrix.copy(Et.matrixWorld),G.matrix.invert(),G.matrix.multiply(ut.matrixWorld)),G.matrix.decompose(G.position,G.quaternion,G.scale),G.updateMatrixWorld(!0),G.projectionMatrix.copy(ut.projectionMatrix),G.projectionMatrixInverse.copy(ut.projectionMatrixInverse),G.isPerspectiveCamera&&(G.fov=Dh*2*Math.atan(1/G.projectionMatrix.elements[5]),G.zoom=1)}this.getCamera=function(){return E},this.getFoveation=function(){if(!(x===null&&M===null))return m},this.setFoveation=function(G){m=G,x!==null&&(x.fixedFoveation=G),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=G)},this.hasDepthSensing=function(){return C.texture!==null};let U=null;function $(G,ut){if(_=ut.getViewerPose(p||d),R=ut,_!==null){const Et=_.views;M!==null&&(e.setRenderTargetFramebuffer(L,M.framebuffer),e.setRenderTarget(L));let xt=!1;Et.length!==E.cameras.length&&(E.cameras.length=0,xt=!0);for(let Pt=0;Pt<Et.length;Pt++){const j=Et[Pt];let ee=null;if(M!==null)ee=M.getViewport(j);else{const ve=S.getViewSubImage(x,j);ee=ve.viewport,Pt===0&&(e.setRenderTargetTextures(L,ve.colorTexture,x.ignoreDepthValues?void 0:ve.depthStencilTexture),e.setRenderTarget(L))}let Gt=T[Pt];Gt===void 0&&(Gt=new ai,Gt.layers.enable(Pt),Gt.viewport=new un,T[Pt]=Gt),Gt.matrix.fromArray(j.transform.matrix),Gt.matrix.decompose(Gt.position,Gt.quaternion,Gt.scale),Gt.projectionMatrix.fromArray(j.projectionMatrix),Gt.projectionMatrixInverse.copy(Gt.projectionMatrix).invert(),Gt.viewport.set(ee.x,ee.y,ee.width,ee.height),Pt===0&&(E.matrix.copy(Gt.matrix),E.matrix.decompose(E.position,E.quaternion,E.scale)),xt===!0&&E.cameras.push(Gt)}const kt=l.enabledFeatures;if(kt&&kt.includes("depth-sensing")){const Pt=S.getDepthInformation(Et[0]);Pt&&Pt.isValid&&Pt.texture&&C.init(e,Pt,l.renderState)}}for(let Et=0;Et<D.length;Et++){const xt=z[Et],kt=D[Et];xt!==null&&kt!==void 0&&kt.update(xt,ut,p||d)}C.render(e,E),U&&U(G,ut),ut.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ut}),R=null}const gt=new Lv;gt.setAnimationLoop($),this.setAnimationLoop=function(G){U=G},this.dispose=function(){}}}const lr=new Ki,db=new Pe;function pb(o,e){function i(y,v){y.matrixAutoUpdate===!0&&y.updateMatrix(),v.value.copy(y.matrix)}function r(y,v){v.color.getRGB(y.fogColor.value,Cv(o)),v.isFog?(y.fogNear.value=v.near,y.fogFar.value=v.far):v.isFogExp2&&(y.fogDensity.value=v.density)}function l(y,v,L,D,z){v.isMeshBasicMaterial||v.isMeshLambertMaterial?c(y,v):v.isMeshToonMaterial?(c(y,v),S(y,v)):v.isMeshPhongMaterial?(c(y,v),_(y,v)):v.isMeshStandardMaterial?(c(y,v),x(y,v),v.isMeshPhysicalMaterial&&M(y,v,z)):v.isMeshMatcapMaterial?(c(y,v),R(y,v)):v.isMeshDepthMaterial?c(y,v):v.isMeshDistanceMaterial?(c(y,v),C(y,v)):v.isMeshNormalMaterial?c(y,v):v.isLineBasicMaterial?(d(y,v),v.isLineDashedMaterial&&h(y,v)):v.isPointsMaterial?m(y,v,L,D):v.isSpriteMaterial?p(y,v):v.isShadowMaterial?(y.color.value.copy(v.color),y.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function c(y,v){y.opacity.value=v.opacity,v.color&&y.diffuse.value.copy(v.color),v.emissive&&y.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.bumpMap&&(y.bumpMap.value=v.bumpMap,i(v.bumpMap,y.bumpMapTransform),y.bumpScale.value=v.bumpScale,v.side===Cn&&(y.bumpScale.value*=-1)),v.normalMap&&(y.normalMap.value=v.normalMap,i(v.normalMap,y.normalMapTransform),y.normalScale.value.copy(v.normalScale),v.side===Cn&&y.normalScale.value.negate()),v.displacementMap&&(y.displacementMap.value=v.displacementMap,i(v.displacementMap,y.displacementMapTransform),y.displacementScale.value=v.displacementScale,y.displacementBias.value=v.displacementBias),v.emissiveMap&&(y.emissiveMap.value=v.emissiveMap,i(v.emissiveMap,y.emissiveMapTransform)),v.specularMap&&(y.specularMap.value=v.specularMap,i(v.specularMap,y.specularMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest);const L=e.get(v),D=L.envMap,z=L.envMapRotation;if(D&&(y.envMap.value=D,lr.copy(z),lr.x*=-1,lr.y*=-1,lr.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(lr.y*=-1,lr.z*=-1),y.envMapRotation.value.setFromMatrix4(db.makeRotationFromEuler(lr)),y.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=v.reflectivity,y.ior.value=v.ior,y.refractionRatio.value=v.refractionRatio),v.lightMap){y.lightMap.value=v.lightMap;const J=o._useLegacyLights===!0?Math.PI:1;y.lightMapIntensity.value=v.lightMapIntensity*J,i(v.lightMap,y.lightMapTransform)}v.aoMap&&(y.aoMap.value=v.aoMap,y.aoMapIntensity.value=v.aoMapIntensity,i(v.aoMap,y.aoMapTransform))}function d(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform))}function h(y,v){y.dashSize.value=v.dashSize,y.totalSize.value=v.dashSize+v.gapSize,y.scale.value=v.scale}function m(y,v,L,D){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.size.value=v.size*L,y.scale.value=D*.5,v.map&&(y.map.value=v.map,i(v.map,y.uvTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function p(y,v){y.diffuse.value.copy(v.color),y.opacity.value=v.opacity,y.rotation.value=v.rotation,v.map&&(y.map.value=v.map,i(v.map,y.mapTransform)),v.alphaMap&&(y.alphaMap.value=v.alphaMap,i(v.alphaMap,y.alphaMapTransform)),v.alphaTest>0&&(y.alphaTest.value=v.alphaTest)}function _(y,v){y.specular.value.copy(v.specular),y.shininess.value=Math.max(v.shininess,1e-4)}function S(y,v){v.gradientMap&&(y.gradientMap.value=v.gradientMap)}function x(y,v){y.metalness.value=v.metalness,v.metalnessMap&&(y.metalnessMap.value=v.metalnessMap,i(v.metalnessMap,y.metalnessMapTransform)),y.roughness.value=v.roughness,v.roughnessMap&&(y.roughnessMap.value=v.roughnessMap,i(v.roughnessMap,y.roughnessMapTransform)),v.envMap&&(y.envMapIntensity.value=v.envMapIntensity)}function M(y,v,L){y.ior.value=v.ior,v.sheen>0&&(y.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),y.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(y.sheenColorMap.value=v.sheenColorMap,i(v.sheenColorMap,y.sheenColorMapTransform)),v.sheenRoughnessMap&&(y.sheenRoughnessMap.value=v.sheenRoughnessMap,i(v.sheenRoughnessMap,y.sheenRoughnessMapTransform))),v.clearcoat>0&&(y.clearcoat.value=v.clearcoat,y.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(y.clearcoatMap.value=v.clearcoatMap,i(v.clearcoatMap,y.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,i(v.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(y.clearcoatNormalMap.value=v.clearcoatNormalMap,i(v.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===Cn&&y.clearcoatNormalScale.value.negate())),v.dispersion>0&&(y.dispersion.value=v.dispersion),v.iridescence>0&&(y.iridescence.value=v.iridescence,y.iridescenceIOR.value=v.iridescenceIOR,y.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(y.iridescenceMap.value=v.iridescenceMap,i(v.iridescenceMap,y.iridescenceMapTransform)),v.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=v.iridescenceThicknessMap,i(v.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),v.transmission>0&&(y.transmission.value=v.transmission,y.transmissionSamplerMap.value=L.texture,y.transmissionSamplerSize.value.set(L.width,L.height),v.transmissionMap&&(y.transmissionMap.value=v.transmissionMap,i(v.transmissionMap,y.transmissionMapTransform)),y.thickness.value=v.thickness,v.thicknessMap&&(y.thicknessMap.value=v.thicknessMap,i(v.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=v.attenuationDistance,y.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(y.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(y.anisotropyMap.value=v.anisotropyMap,i(v.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=v.specularIntensity,y.specularColor.value.copy(v.specularColor),v.specularColorMap&&(y.specularColorMap.value=v.specularColorMap,i(v.specularColorMap,y.specularColorMapTransform)),v.specularIntensityMap&&(y.specularIntensityMap.value=v.specularIntensityMap,i(v.specularIntensityMap,y.specularIntensityMapTransform))}function R(y,v){v.matcap&&(y.matcap.value=v.matcap)}function C(y,v){const L=e.get(v).light;y.referencePosition.value.setFromMatrixPosition(L.matrixWorld),y.nearDistance.value=L.shadow.camera.near,y.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function mb(o,e,i,r){let l={},c={},d=[];const h=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(L,D){const z=D.program;r.uniformBlockBinding(L,z)}function p(L,D){let z=l[L.id];z===void 0&&(R(L),z=_(L),l[L.id]=z,L.addEventListener("dispose",y));const J=D.program;r.updateUBOMapping(L,J);const I=e.render.frame;c[L.id]!==I&&(x(L),c[L.id]=I)}function _(L){const D=S();L.__bindingPointIndex=D;const z=o.createBuffer(),J=L.__size,I=L.usage;return o.bindBuffer(o.UNIFORM_BUFFER,z),o.bufferData(o.UNIFORM_BUFFER,J,I),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,D,z),z}function S(){for(let L=0;L<h;L++)if(d.indexOf(L)===-1)return d.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(L){const D=l[L.id],z=L.uniforms,J=L.__cache;o.bindBuffer(o.UNIFORM_BUFFER,D);for(let I=0,N=z.length;I<N;I++){const O=Array.isArray(z[I])?z[I]:[z[I]];for(let T=0,E=O.length;T<E;T++){const q=O[T];if(M(q,I,T,J)===!0){const st=q.__offset,V=Array.isArray(q.value)?q.value:[q.value];let ht=0;for(let dt=0;dt<V.length;dt++){const F=V[dt],Z=C(F);typeof F=="number"||typeof F=="boolean"?(q.__data[0]=F,o.bufferSubData(o.UNIFORM_BUFFER,st+ht,q.__data)):F.isMatrix3?(q.__data[0]=F.elements[0],q.__data[1]=F.elements[1],q.__data[2]=F.elements[2],q.__data[3]=0,q.__data[4]=F.elements[3],q.__data[5]=F.elements[4],q.__data[6]=F.elements[5],q.__data[7]=0,q.__data[8]=F.elements[6],q.__data[9]=F.elements[7],q.__data[10]=F.elements[8],q.__data[11]=0):(F.toArray(q.__data,ht),ht+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,st,q.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function M(L,D,z,J){const I=L.value,N=D+"_"+z;if(J[N]===void 0)return typeof I=="number"||typeof I=="boolean"?J[N]=I:J[N]=I.clone(),!0;{const O=J[N];if(typeof I=="number"||typeof I=="boolean"){if(O!==I)return J[N]=I,!0}else if(O.equals(I)===!1)return O.copy(I),!0}return!1}function R(L){const D=L.uniforms;let z=0;const J=16;for(let N=0,O=D.length;N<O;N++){const T=Array.isArray(D[N])?D[N]:[D[N]];for(let E=0,q=T.length;E<q;E++){const st=T[E],V=Array.isArray(st.value)?st.value:[st.value];for(let ht=0,dt=V.length;ht<dt;ht++){const F=V[ht],Z=C(F),W=z%J;W!==0&&J-W<Z.boundary&&(z+=J-W),st.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),st.__offset=z,z+=Z.storage}}}const I=z%J;return I>0&&(z+=J-I),L.__size=z,L.__cache={},this}function C(L){const D={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(D.boundary=4,D.storage=4):L.isVector2?(D.boundary=8,D.storage=8):L.isVector3||L.isColor?(D.boundary=16,D.storage=12):L.isVector4?(D.boundary=16,D.storage=16):L.isMatrix3?(D.boundary=48,D.storage=48):L.isMatrix4?(D.boundary=64,D.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),D}function y(L){const D=L.target;D.removeEventListener("dispose",y);const z=d.indexOf(D.__bindingPointIndex);d.splice(z,1),o.deleteBuffer(l[D.id]),delete l[D.id],delete c[D.id]}function v(){for(const L in l)o.deleteBuffer(l[L]);d=[],l={},c={}}return{bind:m,update:p,dispose:v}}class gb{constructor(e={}){const{canvas:i=uy(),context:r=null,depth:l=!0,stencil:c=!1,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:S=!1}=e;this.isWebGLRenderer=!0;let x;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=r.getContextAttributes().alpha}else x=d;const M=new Uint32Array(4),R=new Int32Array(4);let C=null,y=null;const v=[],L=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Si,this._useLegacyLights=!1,this.toneMapping=Na,this.toneMappingExposure=1;const D=this;let z=!1,J=0,I=0,N=null,O=-1,T=null;const E=new un,q=new un;let st=null;const V=new Se(0);let ht=0,dt=i.width,F=i.height,Z=1,W=null,vt=null;const ct=new un(0,0,dt,F),U=new un(0,0,dt,F);let $=!1;const gt=new Bh;let G=!1,ut=!1;const Et=new Pe,xt=new tt,kt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Pt(){return N===null?Z:1}let j=r;function ee(w,Y){return i.getContext(w,Y)}try{const w={alpha:!0,depth:l,stencil:c,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:S};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Oh}`),i.addEventListener("webglcontextlost",X,!1),i.addEventListener("webglcontextrestored",Mt,!1),i.addEventListener("webglcontextcreationerror",mt,!1),j===null){const Y="webgl2";if(j=ee(Y,w),j===null)throw ee(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let Gt,ve,It,ie,Qt,ae,Ce,P,b,ot,lt,yt,St,Lt,At,Tt,jt,bt,Ft,fe,Wt,Dt,qt,$t;function ge(){Gt=new TT(j),Gt.init(),Dt=new sb(j,Gt),ve=new vT(j,Gt,e,Dt),It=new ab(j),ie=new RT(j),Qt=new kA,ae=new rb(j,Gt,It,Qt,ve,Dt,ie),Ce=new xT(D),P=new ET(D),b=new Oy(j),qt=new gT(j,b),ot=new AT(j,b,ie,qt),lt=new wT(j,ot,b,ie),Ft=new CT(j,ve,ae),Tt=new ST(Qt),yt=new XA(D,Ce,P,Gt,ve,qt,Tt),St=new pb(D,Qt),Lt=new qA,At=new JA(Gt),bt=new mT(D,Ce,P,It,lt,x,m),jt=new ib(D,lt,ve),$t=new mb(j,ie,ve,It),fe=new _T(j,Gt,ie),Wt=new bT(j,Gt,ie),ie.programs=yt.programs,D.capabilities=ve,D.extensions=Gt,D.properties=Qt,D.renderLists=Lt,D.shadowMap=jt,D.state=It,D.info=ie}ge();const re=new hb(D,j);this.xr=re,this.getContext=function(){return j},this.getContextAttributes=function(){return j.getContextAttributes()},this.forceContextLoss=function(){const w=Gt.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Gt.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return Z},this.setPixelRatio=function(w){w!==void 0&&(Z=w,this.setSize(dt,F,!1))},this.getSize=function(w){return w.set(dt,F)},this.setSize=function(w,Y,rt=!0){if(re.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}dt=w,F=Y,i.width=Math.floor(w*Z),i.height=Math.floor(Y*Z),rt===!0&&(i.style.width=w+"px",i.style.height=Y+"px"),this.setViewport(0,0,w,Y)},this.getDrawingBufferSize=function(w){return w.set(dt*Z,F*Z).floor()},this.setDrawingBufferSize=function(w,Y,rt){dt=w,F=Y,Z=rt,i.width=Math.floor(w*rt),i.height=Math.floor(Y*rt),this.setViewport(0,0,w,Y)},this.getCurrentViewport=function(w){return w.copy(E)},this.getViewport=function(w){return w.copy(ct)},this.setViewport=function(w,Y,rt,it){w.isVector4?ct.set(w.x,w.y,w.z,w.w):ct.set(w,Y,rt,it),It.viewport(E.copy(ct).multiplyScalar(Z).round())},this.getScissor=function(w){return w.copy(U)},this.setScissor=function(w,Y,rt,it){w.isVector4?U.set(w.x,w.y,w.z,w.w):U.set(w,Y,rt,it),It.scissor(q.copy(U).multiplyScalar(Z).round())},this.getScissorTest=function(){return $},this.setScissorTest=function(w){It.setScissorTest($=w)},this.setOpaqueSort=function(w){W=w},this.setTransparentSort=function(w){vt=w},this.getClearColor=function(w){return w.copy(bt.getClearColor())},this.setClearColor=function(){bt.setClearColor.apply(bt,arguments)},this.getClearAlpha=function(){return bt.getClearAlpha()},this.setClearAlpha=function(){bt.setClearAlpha.apply(bt,arguments)},this.clear=function(w=!0,Y=!0,rt=!0){let it=0;if(w){let nt=!1;if(N!==null){const Rt=N.texture.format;nt=Rt===_v||Rt===gv||Rt===mv}if(nt){const Rt=N.texture.type,zt=Rt===za||Rt===ys||Rt===cv||Rt===Do||Rt===hv||Rt===dv,Ot=bt.getClearColor(),Vt=bt.getClearAlpha(),Zt=Ot.r,Kt=Ot.g,Ht=Ot.b;zt?(M[0]=Zt,M[1]=Kt,M[2]=Ht,M[3]=Vt,j.clearBufferuiv(j.COLOR,0,M)):(R[0]=Zt,R[1]=Kt,R[2]=Ht,R[3]=Vt,j.clearBufferiv(j.COLOR,0,R))}else it|=j.COLOR_BUFFER_BIT}Y&&(it|=j.DEPTH_BUFFER_BIT),rt&&(it|=j.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),j.clear(it)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",X,!1),i.removeEventListener("webglcontextrestored",Mt,!1),i.removeEventListener("webglcontextcreationerror",mt,!1),Lt.dispose(),At.dispose(),Qt.dispose(),Ce.dispose(),P.dispose(),lt.dispose(),qt.dispose(),$t.dispose(),yt.dispose(),re.dispose(),re.removeEventListener("sessionstart",xe),re.removeEventListener("sessionend",Dn),ke.stop()};function X(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),z=!0}function Mt(){console.log("THREE.WebGLRenderer: Context Restored."),z=!1;const w=ie.autoReset,Y=jt.enabled,rt=jt.autoUpdate,it=jt.needsUpdate,nt=jt.type;ge(),ie.autoReset=w,jt.enabled=Y,jt.autoUpdate=rt,jt.needsUpdate=it,jt.type=nt}function mt(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Ct(w){const Y=w.target;Y.removeEventListener("dispose",Ct),Ut(Y)}function Ut(w){le(w),Qt.remove(w)}function le(w){const Y=Qt.get(w).programs;Y!==void 0&&(Y.forEach(function(rt){yt.releaseProgram(rt)}),w.isShaderMaterial&&yt.releaseShaderCache(w))}this.renderBufferDirect=function(w,Y,rt,it,nt,Rt){Y===null&&(Y=kt);const zt=nt.isMesh&&nt.matrixWorld.determinant()<0,Ot=di(w,Y,rt,it,nt);It.setMaterial(it,zt);let Vt=rt.index,Zt=1;if(it.wireframe===!0){if(Vt=ot.getWireframeAttribute(rt),Vt===void 0)return;Zt=2}const Kt=rt.drawRange,Ht=rt.attributes.position;let Ge=Kt.start*Zt,tn=(Kt.start+Kt.count)*Zt;Rt!==null&&(Ge=Math.max(Ge,Rt.start*Zt),tn=Math.min(tn,(Rt.start+Rt.count)*Zt)),Vt!==null?(Ge=Math.max(Ge,0),tn=Math.min(tn,Vt.count)):Ht!=null&&(Ge=Math.max(Ge,0),tn=Math.min(tn,Ht.count));const We=tn-Ge;if(We<0||We===1/0)return;qt.setup(nt,it,Ot,rt,Vt);let mn,ye=fe;if(Vt!==null&&(mn=b.get(Vt),ye=Wt,ye.setIndex(mn)),nt.isMesh)it.wireframe===!0?(It.setLineWidth(it.wireframeLinewidth*Pt()),ye.setMode(j.LINES)):ye.setMode(j.TRIANGLES);else if(nt.isLine){let Jt=it.linewidth;Jt===void 0&&(Jt=1),It.setLineWidth(Jt*Pt()),nt.isLineSegments?ye.setMode(j.LINES):nt.isLineLoop?ye.setMode(j.LINE_LOOP):ye.setMode(j.LINE_STRIP)}else nt.isPoints?ye.setMode(j.POINTS):nt.isSprite&&ye.setMode(j.TRIANGLES);if(nt.isBatchedMesh)nt._multiDrawInstances!==null?ye.renderMultiDrawInstances(nt._multiDrawStarts,nt._multiDrawCounts,nt._multiDrawCount,nt._multiDrawInstances):ye.renderMultiDraw(nt._multiDrawStarts,nt._multiDrawCounts,nt._multiDrawCount);else if(nt.isInstancedMesh)ye.renderInstances(Ge,We,nt.count);else if(rt.isInstancedBufferGeometry){const Jt=rt._maxInstanceCount!==void 0?rt._maxInstanceCount:1/0,$i=Math.min(rt.instanceCount,Jt);ye.renderInstances(Ge,We,$i)}else ye.render(Ge,We)};function Ae(w,Y,rt){w.transparent===!0&&w.side===Yi&&w.forceSinglePass===!1?(w.side=Cn,w.needsUpdate=!0,Ji(w,Y,rt),w.side=Oa,w.needsUpdate=!0,Ji(w,Y,rt),w.side=Yi):Ji(w,Y,rt)}this.compile=function(w,Y,rt=null){rt===null&&(rt=w),y=At.get(rt),y.init(Y),L.push(y),rt.traverseVisible(function(nt){nt.isLight&&nt.layers.test(Y.layers)&&(y.pushLight(nt),nt.castShadow&&y.pushShadow(nt))}),w!==rt&&w.traverseVisible(function(nt){nt.isLight&&nt.layers.test(Y.layers)&&(y.pushLight(nt),nt.castShadow&&y.pushShadow(nt))}),y.setupLights(D._useLegacyLights);const it=new Set;return w.traverse(function(nt){const Rt=nt.material;if(Rt)if(Array.isArray(Rt))for(let zt=0;zt<Rt.length;zt++){const Ot=Rt[zt];Ae(Ot,rt,nt),it.add(Ot)}else Ae(Rt,rt,nt),it.add(Rt)}),L.pop(),y=null,it},this.compileAsync=function(w,Y,rt=null){const it=this.compile(w,Y,rt);return new Promise(nt=>{function Rt(){if(it.forEach(function(zt){Qt.get(zt).currentProgram.isReady()&&it.delete(zt)}),it.size===0){nt(w);return}setTimeout(Rt,10)}Gt.get("KHR_parallel_shader_compile")!==null?Rt():setTimeout(Rt,10)})};let we=null;function sn(w){we&&we(w)}function xe(){ke.stop()}function Dn(){ke.start()}const ke=new Lv;ke.setAnimationLoop(sn),typeof self<"u"&&ke.setContext(self),this.setAnimationLoop=function(w){we=w,re.setAnimationLoop(w),w===null?ke.stop():ke.start()},re.addEventListener("sessionstart",xe),re.addEventListener("sessionend",Dn),this.render=function(w,Y){if(Y!==void 0&&Y.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(z===!0)return;w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),re.enabled===!0&&re.isPresenting===!0&&(re.cameraAutoUpdate===!0&&re.updateCamera(Y),Y=re.getCamera()),w.isScene===!0&&w.onBeforeRender(D,w,Y,N),y=At.get(w,L.length),y.init(Y),L.push(y),Et.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),gt.setFromProjectionMatrix(Et),ut=this.localClippingEnabled,G=Tt.init(this.clippingPlanes,ut),C=Lt.get(w,v.length),C.init(),v.push(C),Oo(w,Y,0,D.sortObjects),C.finish(),D.sortObjects===!0&&C.sort(W,vt);const rt=re.enabled===!1||re.isPresenting===!1||re.hasDepthSensing()===!1;rt&&bt.addToRenderList(C,w),this.info.render.frame++,G===!0&&Tt.beginShadows();const it=y.state.shadowsArray;jt.render(it,w,Y),G===!0&&Tt.endShadows(),this.info.autoReset===!0&&this.info.reset();const nt=C.opaque,Rt=C.transmissive;if(y.setupLights(D._useLegacyLights),Y.isArrayCamera){const zt=Y.cameras;if(Rt.length>0)for(let Ot=0,Vt=zt.length;Ot<Vt;Ot++){const Zt=zt[Ot];Rs(nt,Rt,w,Zt)}rt&&bt.render(w);for(let Ot=0,Vt=zt.length;Ot<Vt;Ot++){const Zt=zt[Ot];bs(C,w,Zt,Zt.viewport)}}else Rt.length>0&&Rs(nt,Rt,w,Y),rt&&bt.render(w),bs(C,w,Y);N!==null&&(ae.updateMultisampleRenderTarget(N),ae.updateRenderTargetMipmap(N)),w.isScene===!0&&w.onAfterRender(D,w,Y),qt.resetDefaultState(),O=-1,T=null,L.pop(),L.length>0?(y=L[L.length-1],G===!0&&Tt.setGlobalState(D.clippingPlanes,y.state.camera)):y=null,v.pop(),v.length>0?C=v[v.length-1]:C=null};function Oo(w,Y,rt,it){if(w.visible===!1)return;if(w.layers.test(Y.layers)){if(w.isGroup)rt=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(Y);else if(w.isLight)y.pushLight(w),w.castShadow&&y.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||gt.intersectsSprite(w)){it&&xt.setFromMatrixPosition(w.matrixWorld).applyMatrix4(Et);const zt=lt.update(w),Ot=w.material;Ot.visible&&C.push(w,zt,Ot,rt,xt.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||gt.intersectsObject(w))){const zt=lt.update(w),Ot=w.material;if(it&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),xt.copy(w.boundingSphere.center)):(zt.boundingSphere===null&&zt.computeBoundingSphere(),xt.copy(zt.boundingSphere.center)),xt.applyMatrix4(w.matrixWorld).applyMatrix4(Et)),Array.isArray(Ot)){const Vt=zt.groups;for(let Zt=0,Kt=Vt.length;Zt<Kt;Zt++){const Ht=Vt[Zt],Ge=Ot[Ht.materialIndex];Ge&&Ge.visible&&C.push(w,zt,Ge,rt,xt.z,Ht)}}else Ot.visible&&C.push(w,zt,Ot,rt,xt.z,null)}}const Rt=w.children;for(let zt=0,Ot=Rt.length;zt<Ot;zt++)Oo(Rt[zt],Y,rt,it)}function bs(w,Y,rt,it){const nt=w.opaque,Rt=w.transmissive,zt=w.transparent;y.setupLightsView(rt),G===!0&&Tt.setGlobalState(D.clippingPlanes,rt),it&&It.viewport(E.copy(it)),nt.length>0&&Ia(nt,Y,rt),Rt.length>0&&Ia(Rt,Y,rt),zt.length>0&&Ia(zt,Y,rt),It.buffers.depth.setTest(!0),It.buffers.depth.setMask(!0),It.buffers.color.setMask(!0),It.setPolygonOffset(!1)}function Rs(w,Y,rt,it){if((rt.isScene===!0?rt.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[it.id]===void 0&&(y.state.transmissionRenderTarget[it.id]=new pr(1,1,{generateMipmaps:!0,type:Gt.has("EXT_color_buffer_half_float")||Gt.has("EXT_color_buffer_float")?Tu:za,minFilter:dr,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1}));const Rt=y.state.transmissionRenderTarget[it.id],zt=it.viewport||E;Rt.setSize(zt.z,zt.w);const Ot=D.getRenderTarget();D.setRenderTarget(Rt),D.getClearColor(V),ht=D.getClearAlpha(),ht<1&&D.setClearColor(16777215,.5),D.clear();const Vt=D.toneMapping;D.toneMapping=Na;const Zt=it.viewport;if(it.viewport!==void 0&&(it.viewport=void 0),y.setupLightsView(it),G===!0&&Tt.setGlobalState(D.clippingPlanes,it),Ia(w,rt,it),ae.updateMultisampleRenderTarget(Rt),ae.updateRenderTargetMipmap(Rt),Gt.has("WEBGL_multisampled_render_to_texture")===!1){let Kt=!1;for(let Ht=0,Ge=Y.length;Ht<Ge;Ht++){const tn=Y[Ht],We=tn.object,mn=tn.geometry,ye=tn.material,Jt=tn.group;if(ye.side===Yi&&We.layers.test(it.layers)){const $i=ye.side;ye.side=Cn,ye.needsUpdate=!0,_r(We,rt,it,mn,ye,Jt),ye.side=$i,ye.needsUpdate=!0,Kt=!0}}Kt===!0&&(ae.updateMultisampleRenderTarget(Rt),ae.updateRenderTargetMipmap(Rt))}D.setRenderTarget(Ot),D.setClearColor(V,ht),Zt!==void 0&&(it.viewport=Zt),D.toneMapping=Vt}function Ia(w,Y,rt){const it=Y.isScene===!0?Y.overrideMaterial:null;for(let nt=0,Rt=w.length;nt<Rt;nt++){const zt=w[nt],Ot=zt.object,Vt=zt.geometry,Zt=it===null?zt.material:it,Kt=zt.group;Ot.layers.test(rt.layers)&&_r(Ot,Y,rt,Vt,Zt,Kt)}}function _r(w,Y,rt,it,nt,Rt){w.onBeforeRender(D,Y,rt,it,nt,Rt),w.modelViewMatrix.multiplyMatrices(rt.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),nt.onBeforeRender(D,Y,rt,it,w,Rt),nt.transparent===!0&&nt.side===Yi&&nt.forceSinglePass===!1?(nt.side=Cn,nt.needsUpdate=!0,D.renderBufferDirect(rt,Y,it,nt,w,Rt),nt.side=Oa,nt.needsUpdate=!0,D.renderBufferDirect(rt,Y,it,nt,w,Rt),nt.side=Yi):D.renderBufferDirect(rt,Y,it,nt,w,Rt),w.onAfterRender(D,Y,rt,it,nt,Rt)}function Ji(w,Y,rt){Y.isScene!==!0&&(Y=kt);const it=Qt.get(w),nt=y.state.lights,Rt=y.state.shadowsArray,zt=nt.state.version,Ot=yt.getParameters(w,nt.state,Rt,Y,rt),Vt=yt.getProgramCacheKey(Ot);let Zt=it.programs;it.environment=w.isMeshStandardMaterial?Y.environment:null,it.fog=Y.fog,it.envMap=(w.isMeshStandardMaterial?P:Ce).get(w.envMap||it.environment),it.envMapRotation=it.environment!==null&&w.envMap===null?Y.environmentRotation:w.envMapRotation,Zt===void 0&&(w.addEventListener("dispose",Ct),Zt=new Map,it.programs=Zt);let Kt=Zt.get(Vt);if(Kt!==void 0){if(it.currentProgram===Kt&&it.lightsStateVersion===zt)return ws(w,Ot),Kt}else Ot.uniforms=yt.getUniforms(w),w.onBuild(rt,Ot,D),w.onBeforeCompile(Ot,D),Kt=yt.acquireProgram(Ot,Vt),Zt.set(Vt,Kt),it.uniforms=Ot.uniforms;const Ht=it.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Ht.clippingPlanes=Tt.uniform),ws(w,Ot),it.needsLights=pn(w),it.lightsStateVersion=zt,it.needsLights&&(Ht.ambientLightColor.value=nt.state.ambient,Ht.lightProbe.value=nt.state.probe,Ht.directionalLights.value=nt.state.directional,Ht.directionalLightShadows.value=nt.state.directionalShadow,Ht.spotLights.value=nt.state.spot,Ht.spotLightShadows.value=nt.state.spotShadow,Ht.rectAreaLights.value=nt.state.rectArea,Ht.ltc_1.value=nt.state.rectAreaLTC1,Ht.ltc_2.value=nt.state.rectAreaLTC2,Ht.pointLights.value=nt.state.point,Ht.pointLightShadows.value=nt.state.pointShadow,Ht.hemisphereLights.value=nt.state.hemi,Ht.directionalShadowMap.value=nt.state.directionalShadowMap,Ht.directionalShadowMatrix.value=nt.state.directionalShadowMatrix,Ht.spotShadowMap.value=nt.state.spotShadowMap,Ht.spotLightMatrix.value=nt.state.spotLightMatrix,Ht.spotLightMap.value=nt.state.spotLightMap,Ht.pointShadowMap.value=nt.state.pointShadowMap,Ht.pointShadowMatrix.value=nt.state.pointShadowMatrix),it.currentProgram=Kt,it.uniformsList=null,Kt}function Cs(w){if(w.uniformsList===null){const Y=w.currentProgram.getUniforms();w.uniformsList=gu.seqWithValue(Y.seq,w.uniforms)}return w.uniformsList}function ws(w,Y){const rt=Qt.get(w);rt.outputColorSpace=Y.outputColorSpace,rt.batching=Y.batching,rt.instancing=Y.instancing,rt.instancingColor=Y.instancingColor,rt.instancingMorph=Y.instancingMorph,rt.skinning=Y.skinning,rt.morphTargets=Y.morphTargets,rt.morphNormals=Y.morphNormals,rt.morphColors=Y.morphColors,rt.morphTargetsCount=Y.morphTargetsCount,rt.numClippingPlanes=Y.numClippingPlanes,rt.numIntersection=Y.numClipIntersection,rt.vertexAlphas=Y.vertexAlphas,rt.vertexTangents=Y.vertexTangents,rt.toneMapping=Y.toneMapping}function di(w,Y,rt,it,nt){Y.isScene!==!0&&(Y=kt),ae.resetTextureUnits();const Rt=Y.fog,zt=it.isMeshStandardMaterial?Y.environment:null,Ot=N===null?D.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Pa,Vt=(it.isMeshStandardMaterial?P:Ce).get(it.envMap||zt),Zt=it.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,Kt=!!rt.attributes.tangent&&(!!it.normalMap||it.anisotropy>0),Ht=!!rt.morphAttributes.position,Ge=!!rt.morphAttributes.normal,tn=!!rt.morphAttributes.color;let We=Na;it.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(We=D.toneMapping);const mn=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,ye=mn!==void 0?mn.length:0,Jt=Qt.get(it),$i=y.state.lights;if(G===!0&&(ut===!0||w!==T)){const Mn=w===T&&it.id===O;Tt.setState(it,w,Mn)}let ze=!1;it.version===Jt.__version?(Jt.needsLights&&Jt.lightsStateVersion!==$i.state.version||Jt.outputColorSpace!==Ot||nt.isBatchedMesh&&Jt.batching===!1||!nt.isBatchedMesh&&Jt.batching===!0||nt.isInstancedMesh&&Jt.instancing===!1||!nt.isInstancedMesh&&Jt.instancing===!0||nt.isSkinnedMesh&&Jt.skinning===!1||!nt.isSkinnedMesh&&Jt.skinning===!0||nt.isInstancedMesh&&Jt.instancingColor===!0&&nt.instanceColor===null||nt.isInstancedMesh&&Jt.instancingColor===!1&&nt.instanceColor!==null||nt.isInstancedMesh&&Jt.instancingMorph===!0&&nt.morphTexture===null||nt.isInstancedMesh&&Jt.instancingMorph===!1&&nt.morphTexture!==null||Jt.envMap!==Vt||it.fog===!0&&Jt.fog!==Rt||Jt.numClippingPlanes!==void 0&&(Jt.numClippingPlanes!==Tt.numPlanes||Jt.numIntersection!==Tt.numIntersection)||Jt.vertexAlphas!==Zt||Jt.vertexTangents!==Kt||Jt.morphTargets!==Ht||Jt.morphNormals!==Ge||Jt.morphColors!==tn||Jt.toneMapping!==We||Jt.morphTargetsCount!==ye)&&(ze=!0):(ze=!0,Jt.__version=it.version);let jn=Jt.currentProgram;ze===!0&&(jn=Ji(it,Y,nt));let Fa=!1,yn=!1,gn=!1;const en=jn.getUniforms(),pi=Jt.uniforms;if(It.useProgram(jn.program)&&(Fa=!0,yn=!0,gn=!0),it.id!==O&&(O=it.id,yn=!0),Fa||T!==w){en.setValue(j,"projectionMatrix",w.projectionMatrix),en.setValue(j,"viewMatrix",w.matrixWorldInverse);const Mn=en.map.cameraPosition;Mn!==void 0&&Mn.setValue(j,xt.setFromMatrixPosition(w.matrixWorld)),ve.logarithmicDepthBuffer&&en.setValue(j,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(it.isMeshPhongMaterial||it.isMeshToonMaterial||it.isMeshLambertMaterial||it.isMeshBasicMaterial||it.isMeshStandardMaterial||it.isShaderMaterial)&&en.setValue(j,"isOrthographic",w.isOrthographicCamera===!0),T!==w&&(T=w,yn=!0,gn=!0)}if(nt.isSkinnedMesh){en.setOptional(j,nt,"bindMatrix"),en.setOptional(j,nt,"bindMatrixInverse");const Mn=nt.skeleton;Mn&&(Mn.boneTexture===null&&Mn.computeBoneTexture(),en.setValue(j,"boneTexture",Mn.boneTexture,ae))}nt.isBatchedMesh&&(en.setOptional(j,nt,"batchingTexture"),en.setValue(j,"batchingTexture",nt._matricesTexture,ae));const Ha=rt.morphAttributes;if((Ha.position!==void 0||Ha.normal!==void 0||Ha.color!==void 0)&&Ft.update(nt,rt,jn),(yn||Jt.receiveShadow!==nt.receiveShadow)&&(Jt.receiveShadow=nt.receiveShadow,en.setValue(j,"receiveShadow",nt.receiveShadow)),it.isMeshGouraudMaterial&&it.envMap!==null&&(pi.envMap.value=Vt,pi.flipEnvMap.value=Vt.isCubeTexture&&Vt.isRenderTargetTexture===!1?-1:1),it.isMeshStandardMaterial&&it.envMap===null&&Y.environment!==null&&(pi.envMapIntensity.value=Y.environmentIntensity),yn&&(en.setValue(j,"toneMappingExposure",D.toneMappingExposure),Jt.needsLights&&$e(pi,gn),Rt&&it.fog===!0&&St.refreshFogUniforms(pi,Rt),St.refreshMaterialUniforms(pi,it,Z,F,y.state.transmissionRenderTarget[w.id]),gu.upload(j,Cs(Jt),pi,ae)),it.isShaderMaterial&&it.uniformsNeedUpdate===!0&&(gu.upload(j,Cs(Jt),pi,ae),it.uniformsNeedUpdate=!1),it.isSpriteMaterial&&en.setValue(j,"center",nt.center),en.setValue(j,"modelViewMatrix",nt.modelViewMatrix),en.setValue(j,"normalMatrix",nt.normalMatrix),en.setValue(j,"modelMatrix",nt.matrixWorld),it.isShaderMaterial||it.isRawShaderMaterial){const Mn=it.uniformsGroups;for(let ta=0,Cu=Mn.length;ta<Cu;ta++){const En=Mn[ta];$t.update(En,jn),$t.bind(En,jn)}}return jn}function $e(w,Y){w.ambientLightColor.needsUpdate=Y,w.lightProbe.needsUpdate=Y,w.directionalLights.needsUpdate=Y,w.directionalLightShadows.needsUpdate=Y,w.pointLights.needsUpdate=Y,w.pointLightShadows.needsUpdate=Y,w.spotLights.needsUpdate=Y,w.spotLightShadows.needsUpdate=Y,w.rectAreaLights.needsUpdate=Y,w.hemisphereLights.needsUpdate=Y}function pn(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return J},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(w,Y,rt){Qt.get(w.texture).__webglTexture=Y,Qt.get(w.depthTexture).__webglTexture=rt;const it=Qt.get(w);it.__hasExternalTextures=!0,it.__autoAllocateDepthBuffer=rt===void 0,it.__autoAllocateDepthBuffer||Gt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),it.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,Y){const rt=Qt.get(w);rt.__webglFramebuffer=Y,rt.__useDefaultFramebuffer=Y===void 0},this.setRenderTarget=function(w,Y=0,rt=0){N=w,J=Y,I=rt;let it=!0,nt=null,Rt=!1,zt=!1;if(w){const Vt=Qt.get(w);Vt.__useDefaultFramebuffer!==void 0?(It.bindFramebuffer(j.FRAMEBUFFER,null),it=!1):Vt.__webglFramebuffer===void 0?ae.setupRenderTarget(w):Vt.__hasExternalTextures&&ae.rebindTextures(w,Qt.get(w.texture).__webglTexture,Qt.get(w.depthTexture).__webglTexture);const Zt=w.texture;(Zt.isData3DTexture||Zt.isDataArrayTexture||Zt.isCompressedArrayTexture)&&(zt=!0);const Kt=Qt.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(Kt[Y])?nt=Kt[Y][rt]:nt=Kt[Y],Rt=!0):w.samples>0&&ae.useMultisampledRTT(w)===!1?nt=Qt.get(w).__webglMultisampledFramebuffer:Array.isArray(Kt)?nt=Kt[rt]:nt=Kt,E.copy(w.viewport),q.copy(w.scissor),st=w.scissorTest}else E.copy(ct).multiplyScalar(Z).floor(),q.copy(U).multiplyScalar(Z).floor(),st=$;if(It.bindFramebuffer(j.FRAMEBUFFER,nt)&&it&&It.drawBuffers(w,nt),It.viewport(E),It.scissor(q),It.setScissorTest(st),Rt){const Vt=Qt.get(w.texture);j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,j.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Vt.__webglTexture,rt)}else if(zt){const Vt=Qt.get(w.texture),Zt=Y||0;j.framebufferTextureLayer(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,Vt.__webglTexture,rt||0,Zt)}O=-1},this.readRenderTargetPixels=function(w,Y,rt,it,nt,Rt,zt){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ot=Qt.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&zt!==void 0&&(Ot=Ot[zt]),Ot){It.bindFramebuffer(j.FRAMEBUFFER,Ot);try{const Vt=w.texture,Zt=Vt.format,Kt=Vt.type;if(!ve.textureFormatReadable(Zt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ve.textureTypeReadable(Kt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=w.width-it&&rt>=0&&rt<=w.height-nt&&j.readPixels(Y,rt,it,nt,Dt.convert(Zt),Dt.convert(Kt),Rt)}finally{const Vt=N!==null?Qt.get(N).__webglFramebuffer:null;It.bindFramebuffer(j.FRAMEBUFFER,Vt)}}},this.copyFramebufferToTexture=function(w,Y,rt=0){const it=Math.pow(2,-rt),nt=Math.floor(Y.image.width*it),Rt=Math.floor(Y.image.height*it);ae.setTexture2D(Y,0),j.copyTexSubImage2D(j.TEXTURE_2D,rt,0,0,w.x,w.y,nt,Rt),It.unbindTexture()},this.copyTextureToTexture=function(w,Y,rt,it=0){const nt=Y.image.width,Rt=Y.image.height,zt=Dt.convert(rt.format),Ot=Dt.convert(rt.type);ae.setTexture2D(rt,0),j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,rt.flipY),j.pixelStorei(j.UNPACK_PREMULTIPLY_ALPHA_WEBGL,rt.premultiplyAlpha),j.pixelStorei(j.UNPACK_ALIGNMENT,rt.unpackAlignment),Y.isDataTexture?j.texSubImage2D(j.TEXTURE_2D,it,w.x,w.y,nt,Rt,zt,Ot,Y.image.data):Y.isCompressedTexture?j.compressedTexSubImage2D(j.TEXTURE_2D,it,w.x,w.y,Y.mipmaps[0].width,Y.mipmaps[0].height,zt,Y.mipmaps[0].data):j.texSubImage2D(j.TEXTURE_2D,it,w.x,w.y,zt,Ot,Y.image),it===0&&rt.generateMipmaps&&j.generateMipmap(j.TEXTURE_2D),It.unbindTexture()},this.copyTextureToTexture3D=function(w,Y,rt,it,nt=0){const Rt=w.max.x-w.min.x,zt=w.max.y-w.min.y,Ot=w.max.z-w.min.z,Vt=Dt.convert(it.format),Zt=Dt.convert(it.type);let Kt;if(it.isData3DTexture)ae.setTexture3D(it,0),Kt=j.TEXTURE_3D;else if(it.isDataArrayTexture||it.isCompressedArrayTexture)ae.setTexture2DArray(it,0),Kt=j.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,it.flipY),j.pixelStorei(j.UNPACK_PREMULTIPLY_ALPHA_WEBGL,it.premultiplyAlpha),j.pixelStorei(j.UNPACK_ALIGNMENT,it.unpackAlignment);const Ht=j.getParameter(j.UNPACK_ROW_LENGTH),Ge=j.getParameter(j.UNPACK_IMAGE_HEIGHT),tn=j.getParameter(j.UNPACK_SKIP_PIXELS),We=j.getParameter(j.UNPACK_SKIP_ROWS),mn=j.getParameter(j.UNPACK_SKIP_IMAGES),ye=rt.isCompressedTexture?rt.mipmaps[nt]:rt.image;j.pixelStorei(j.UNPACK_ROW_LENGTH,ye.width),j.pixelStorei(j.UNPACK_IMAGE_HEIGHT,ye.height),j.pixelStorei(j.UNPACK_SKIP_PIXELS,w.min.x),j.pixelStorei(j.UNPACK_SKIP_ROWS,w.min.y),j.pixelStorei(j.UNPACK_SKIP_IMAGES,w.min.z),rt.isDataTexture||rt.isData3DTexture?j.texSubImage3D(Kt,nt,Y.x,Y.y,Y.z,Rt,zt,Ot,Vt,Zt,ye.data):it.isCompressedArrayTexture?j.compressedTexSubImage3D(Kt,nt,Y.x,Y.y,Y.z,Rt,zt,Ot,Vt,ye.data):j.texSubImage3D(Kt,nt,Y.x,Y.y,Y.z,Rt,zt,Ot,Vt,Zt,ye),j.pixelStorei(j.UNPACK_ROW_LENGTH,Ht),j.pixelStorei(j.UNPACK_IMAGE_HEIGHT,Ge),j.pixelStorei(j.UNPACK_SKIP_PIXELS,tn),j.pixelStorei(j.UNPACK_SKIP_ROWS,We),j.pixelStorei(j.UNPACK_SKIP_IMAGES,mn),nt===0&&it.generateMipmaps&&j.generateMipmap(Kt),It.unbindTexture()},this.initTexture=function(w){w.isCubeTexture?ae.setTextureCube(w,0):w.isData3DTexture?ae.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?ae.setTexture2DArray(w,0):ae.setTexture2D(w,0),It.unbindTexture()},this.resetState=function(){J=0,I=0,N=null,It.reset(),qt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Zi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=e===zh?"display-p3":"srgb",i.unpackColorSpace=Ne.workingColorSpace===Au?"display-p3":"srgb"}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class _b extends xn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Ki,this.environmentIntensity=1,this.environmentRotation=new Ki,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,i){return super.copy(e,i),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const i=super.toJSON(e);return this.fog!==null&&(i.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(i.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(i.object.backgroundIntensity=this.backgroundIntensity),i.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(i.object.environmentIntensity=this.environmentIntensity),i.object.environmentRotation=this.environmentRotation.toArray(),i}}class vb extends wn{constructor(e=null,i=1,r=1,l,c,d,h,m,p=In,_=In,S,x){super(null,d,h,m,p,_,l,c,S,x),this.isDataTexture=!0,this.image={data:e,width:i,height:r},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}class $_ extends hi{constructor(e,i,r,l=1){super(e,i,r),this.isInstancedBufferAttribute=!0,this.meshPerAttribute=l}copy(e){return super.copy(e),this.meshPerAttribute=e.meshPerAttribute,this}toJSON(){const e=super.toJSON();return e.meshPerAttribute=this.meshPerAttribute,e.isInstancedBufferAttribute=!0,e}}const ps=new Pe,tv=new Pe,du=[],ev=new gr,Sb=new Pe,Ao=new Rn,bo=new Lo;class Mh extends Rn{constructor(e,i,r){super(e,i),this.isInstancedMesh=!0,this.instanceMatrix=new $_(new Float32Array(r*16),16),this.instanceColor=null,this.morphTexture=null,this.count=r,this.boundingBox=null,this.boundingSphere=null;for(let l=0;l<r;l++)this.setMatrixAt(l,Sb)}computeBoundingBox(){const e=this.geometry,i=this.count;this.boundingBox===null&&(this.boundingBox=new gr),e.boundingBox===null&&e.computeBoundingBox(),this.boundingBox.makeEmpty();for(let r=0;r<i;r++)this.getMatrixAt(r,ps),ev.copy(e.boundingBox).applyMatrix4(ps),this.boundingBox.union(ev)}computeBoundingSphere(){const e=this.geometry,i=this.count;this.boundingSphere===null&&(this.boundingSphere=new Lo),e.boundingSphere===null&&e.computeBoundingSphere(),this.boundingSphere.makeEmpty();for(let r=0;r<i;r++)this.getMatrixAt(r,ps),bo.copy(e.boundingSphere).applyMatrix4(ps),this.boundingSphere.union(bo)}copy(e,i){return super.copy(e,i),this.instanceMatrix.copy(e.instanceMatrix),e.morphTexture!==null&&(this.morphTexture=e.morphTexture.clone()),e.instanceColor!==null&&(this.instanceColor=e.instanceColor.clone()),this.count=e.count,e.boundingBox!==null&&(this.boundingBox=e.boundingBox.clone()),e.boundingSphere!==null&&(this.boundingSphere=e.boundingSphere.clone()),this}getColorAt(e,i){i.fromArray(this.instanceColor.array,e*3)}getMatrixAt(e,i){i.fromArray(this.instanceMatrix.array,e*16)}getMorphAt(e,i){const r=i.morphTargetInfluences,l=this.morphTexture.source.data.data,c=r.length+1,d=e*c+1;for(let h=0;h<r.length;h++)r[h]=l[d+h]}raycast(e,i){const r=this.matrixWorld,l=this.count;if(Ao.geometry=this.geometry,Ao.material=this.material,Ao.material!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),bo.copy(this.boundingSphere),bo.applyMatrix4(r),e.ray.intersectsSphere(bo)!==!1))for(let c=0;c<l;c++){this.getMatrixAt(c,ps),tv.multiplyMatrices(r,ps),Ao.matrixWorld=tv,Ao.raycast(e,du);for(let d=0,h=du.length;d<h;d++){const m=du[d];m.instanceId=c,m.object=this,i.push(m)}du.length=0}}setColorAt(e,i){this.instanceColor===null&&(this.instanceColor=new $_(new Float32Array(this.instanceMatrix.count*3),3)),i.toArray(this.instanceColor.array,e*3)}setMatrixAt(e,i){i.toArray(this.instanceMatrix.array,e*16)}setMorphAt(e,i){const r=i.morphTargetInfluences,l=r.length+1;this.morphTexture===null&&(this.morphTexture=new vb(new Float32Array(l*this.count),l,this.count,pv,ji));const c=this.morphTexture.source.data.data;let d=0;for(let p=0;p<r.length;p++)d+=r[p];const h=this.geometry.morphTargetsRelative?1:1-d,m=l*e;c[m]=h,c.set(r,m+1)}updateMorphTargets(){}dispose(){return this.dispatchEvent({type:"dispose"}),this.morphTexture!==null&&(this.morphTexture.dispose(),this.morphTexture=null),this}}class Fh extends Ba{constructor(e=[new oe(0,-.5),new oe(.5,0),new oe(0,.5)],i=12,r=0,l=Math.PI*2){super(),this.type="LatheGeometry",this.parameters={points:e,segments:i,phiStart:r,phiLength:l},i=Math.floor(i),l=bn(l,0,Math.PI*2);const c=[],d=[],h=[],m=[],p=[],_=1/i,S=new tt,x=new oe,M=new tt,R=new tt,C=new tt;let y=0,v=0;for(let L=0;L<=e.length-1;L++)switch(L){case 0:y=e[L+1].x-e[L].x,v=e[L+1].y-e[L].y,M.x=v*1,M.y=-y,M.z=v*0,C.copy(M),M.normalize(),m.push(M.x,M.y,M.z);break;case e.length-1:m.push(C.x,C.y,C.z);break;default:y=e[L+1].x-e[L].x,v=e[L+1].y-e[L].y,M.x=v*1,M.y=-y,M.z=v*0,R.copy(M),M.x+=C.x,M.y+=C.y,M.z+=C.z,M.normalize(),m.push(M.x,M.y,M.z),C.copy(R)}for(let L=0;L<=i;L++){const D=r+L*_*l,z=Math.sin(D),J=Math.cos(D);for(let I=0;I<=e.length-1;I++){S.x=e[I].x*z,S.y=e[I].y,S.z=e[I].x*J,d.push(S.x,S.y,S.z),x.x=L/i,x.y=I/(e.length-1),h.push(x.x,x.y);const N=m[3*I+0]*z,O=m[3*I+1],T=m[3*I+0]*J;p.push(N,O,T)}}for(let L=0;L<i;L++)for(let D=0;D<e.length-1;D++){const z=D+L*e.length,J=z,I=z+e.length,N=z+e.length+1,O=z+1;c.push(J,I,O),c.push(N,O,I)}this.setIndex(c),this.setAttribute("position",new Ei(d,3)),this.setAttribute("uv",new Ei(h,2)),this.setAttribute("normal",new Ei(p,3))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Fh(e.points,e.segments,e.phiStart,e.phiLength)}}class pu extends No{constructor(e){super(),this.isMeshToonMaterial=!0,this.defines={TOON:""},this.type="MeshToonMaterial",this.color=new Se(16777215),this.map=null,this.gradientMap=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Se(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=vv,this.normalScale=new oe(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.alphaMap=null,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.gradientMap=e.gradientMap,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.alphaMap=e.alphaMap,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.fog=e.fog,this}}class Hv extends xn{constructor(e,i=1){super(),this.isLight=!0,this.type="Light",this.color=new Se(e),this.intensity=i}dispose(){}copy(e,i){return super.copy(e,i),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const i=super.toJSON(e);return i.object.color=this.color.getHex(),i.object.intensity=this.intensity,this.groundColor!==void 0&&(i.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(i.object.distance=this.distance),this.angle!==void 0&&(i.object.angle=this.angle),this.decay!==void 0&&(i.object.decay=this.decay),this.penumbra!==void 0&&(i.object.penumbra=this.penumbra),this.shadow!==void 0&&(i.object.shadow=this.shadow.toJSON()),i}}const Eh=new Pe,nv=new tt,iv=new tt;class xb{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new oe(512,512),this.map=null,this.mapPass=null,this.matrix=new Pe,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Bh,this._frameExtents=new oe(1,1),this._viewportCount=1,this._viewports=[new un(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const i=this.camera,r=this.matrix;nv.setFromMatrixPosition(e.matrixWorld),i.position.copy(nv),iv.setFromMatrixPosition(e.target.matrixWorld),i.lookAt(iv),i.updateMatrixWorld(),Eh.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Eh),r.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),r.multiply(Eh)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class yb extends xb{constructor(){super(new Nv(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Mb extends Hv{constructor(e,i){super(e,i),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(xn.DEFAULT_UP),this.updateMatrix(),this.target=new xn,this.shadow=new yb}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Eb extends Hv{constructor(e,i){super(e,i),this.isAmbientLight=!0,this.type="AmbientLight"}}const av=new Pe;class Tb{constructor(e,i,r=0,l=1/0){this.ray=new Ev(e,i),this.near=r,this.far=l,this.camera=null,this.layers=new Ph,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,i){this.ray.set(e,i)}setFromCamera(e,i){i.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(i.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(i).sub(this.ray.origin).normalize(),this.camera=i):i.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(i.near+i.far)/(i.near-i.far)).unproject(i),this.ray.direction.set(0,0,-1).transformDirection(i.matrixWorld),this.camera=i):console.error("THREE.Raycaster: Unsupported camera type: "+i.type)}setFromXRController(e){return av.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(av),this}intersectObject(e,i=!0,r=[]){return Lh(e,this,r,i),r.sort(rv),r}intersectObjects(e,i=!0,r=[]){for(let l=0,c=e.length;l<c;l++)Lh(e[l],this,r,i);return r.sort(rv),r}}function rv(o,e){return o.distance-e.distance}function Lh(o,e,i,r){if(o.layers.test(e.layers)&&o.raycast(e,i),r===!0){const l=o.children;for(let c=0,d=l.length;c<d;c++)Lh(l[c],e,i,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Oh}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Oh);class Ab{constructor(e,i={}){this.enabled=!0;const r=i.defaultThickness!==void 0?i.defaultThickness:.003,l=new Se().fromArray(i.defaultColor!==void 0?i.defaultColor:[0,0,0]),c=i.defaultAlpha!==void 0?i.defaultAlpha:1,d=i.defaultKeepAlive!==void 0?i.defaultKeepAlive:!1,h={},m=60,p={},_={},S={outlineThickness:{value:r},outlineColor:{value:l},outlineAlpha:{value:c}},x=["#include <common>","#include <uv_pars_vertex>","#include <displacementmap_pars_vertex>","#include <fog_pars_vertex>","#include <morphtarget_pars_vertex>","#include <skinning_pars_vertex>","#include <logdepthbuf_pars_vertex>","#include <clipping_planes_pars_vertex>","uniform float outlineThickness;","vec4 calculateOutline( vec4 pos, vec3 normal, vec4 skinned ) {","	float thickness = outlineThickness;","	const float ratio = 1.0;","	vec4 pos2 = projectionMatrix * modelViewMatrix * vec4( skinned.xyz + normal, 1.0 );","	vec4 norm = normalize( pos - pos2 );","	return pos + norm * thickness * pos.w * ratio;","}","void main() {","	#include <uv_vertex>","	#include <beginnormal_vertex>","	#include <morphnormal_vertex>","	#include <skinbase_vertex>","	#include <skinnormal_vertex>","	#include <begin_vertex>","	#include <morphtarget_vertex>","	#include <skinning_vertex>","	#include <displacementmap_vertex>","	#include <project_vertex>","	vec3 outlineNormal = - objectNormal;","	gl_Position = calculateOutline( gl_Position, outlineNormal, vec4( transformed, 1.0 ) );","	#include <logdepthbuf_vertex>","	#include <clipping_planes_vertex>","	#include <fog_vertex>","}"].join(`
...
`);function R(){return new Qi({type:"OutlineEffect",uniforms:wv.merge([wt.fog,wt.displacementmap,S]),vertexShader:x,fragmentShader:M,side:Cn})}function C(O){let T=h[O.uuid];return T===void 0&&(T={material:R(),used:!0,keepAlive:d,count:0},h[O.uuid]=T),T.used=!0,T.material}function y(O){const T=C(O);return p[T.uuid]=O,I(T,O),T}function v(O){const T=O.geometry,E=T!==void 0&&T.attributes.normal!==void 0;return O.isMesh===!0&&O.material!==void 0&&E===!0}function L(O){if(v(O)!==!1){if(Array.isArray(O.material))for(let T=0,E=O.material.length;T<E;T++)O.material[T]=y(O.material[T]);else O.material=y(O.material);_[O.uuid]=O.onBeforeRender,O.onBeforeRender=z}}function D(O){if(v(O)!==!1){if(Array.isArray(O.material))for(let T=0,E=O.material.length;T<E;T++)O.material[T]=p[O.material[T].uuid];else O.material=p[O.material.uuid];O.onBeforeRender=_[O.uuid]}}function z(O,T,E,q,st){const V=p[st.uuid];V!==void 0&&J(st,V)}function J(O,T){const E=T.userData.outlineParameters;O.uniforms.outlineAlpha.value=T.opacity,E!==void 0&&(E.thickness!==void 0&&(O.uniforms.outlineThickness.value=E.thickness),E.color!==void 0&&O.uniforms.outlineColor.value.fromArray(E.color),E.alpha!==void 0&&(O.uniforms.outlineAlpha.value=E.alpha)),T.displacementMap&&(O.uniforms.displacementMap.value=T.displacementMap,O.uniforms.displacementScale.value=T.displacementScale,O.uniforms.displacementBias.value=T.displacementBias)}function I(O,T){if(O.name==="invisible")return;const E=T.userData.outlineParameters;O.fog=T.fog,O.toneMapped=T.toneMapped,O.premultipliedAlpha=T.premultipliedAlpha,O.displacementMap=T.displacementMap,E!==void 0?(T.visible===!1?O.visible=!1:O.visible=E.visible!==void 0?E.visible:!0,O.transparent=E.alpha!==void 0&&E.alpha<1?!0:T.transparent,E.keepAlive!==void 0&&(h[T.uuid].keepAlive=E.keepAlive)):(O.transparent=T.transparent,O.visible=T.visible),(T.wireframe===!0||T.depthTest===!1)&&(O.visible=!1),T.clippingPlanes&&(O.clipping=!0,O.clippingPlanes=T.clippingPlanes,O.clipIntersection=T.clipIntersection,O.clipShadows=T.clipShadows),O.version=T.version}function N(){let O;O=Object.keys(p);for(let T=0,E=O.length;T<E;T++)p[O[T]]=void 0;O=Object.keys(_);for(let T=0,E=O.length;T<E;T++)_[O[T]]=void 0;O=Object.keys(h);for(let T=0,E=O.length;T<E;T++){const q=O[T];h[q].used===!1?(h[q].count++,h[q].keepAlive===!1&&h[q].count>m&&delete h[q]):(h[q].used=!1,h[q].count=0)}}this.render=function(O,T){if(this.enabled===!1){e.render(O,T);return}const E=e.autoClear;e.autoClear=this.autoClear,e.render(O,T),e.autoClear=E,this.renderOutline(O,T)},this.renderOutline=function(O,T){const E=e.autoClear,q=O.matrixWorldAutoUpdate,st=O.background,V=e.shadowMap.enabled;O.matrixWorldAutoUpdate=!1,O.background=null,e.autoClear=!1,e.shadowMap.enabled=!1,O.traverse(L),e.render(O,T),O.traverse(D),N(),O.matrixWorldAutoUpdate=q,O.background=st,e.autoClear=E,e.shadowMap.enabled=V},this.autoClear=e.autoClear,this.domElement=e.domElement,this.shadowMap=e.shadowMap,this.clear=function(O,T,E){e.clear(O,T,E)},this.getPixelRatio=function(){return e.getPixelRatio()},this.setPixelRatio=function(O){e.setPixelRatio(O)},this.getSize=function(O){return e.getSize(O)},this.setSize=function(O,T,E){e.setSize(O,T,E)},this.setViewport=function(O,T,E,q){e.setViewport(O,T,E,q)},this.setScissor=function(O,T,E,q){e.setScissor(O,T,E,q)},this.setScissorTest=function(O){e.setScissorTest(O)},this.setRenderTarget=function(O){e.setRenderTarget(O)}}}function bb(o){return new Worker("/coleslaw/assets/physics.worker-CBwRZVfk.js",{name:o==null?void 0:o.name})}const Rb=()=>{const o=mu.useRef(null),e=mu.useRef(!1);return mu.useEffect(()=>{if(e.current||!o.current)return;e.current=!0;let i,r,l,c,d,h;const m=async()=>{const _=o.current;if(!_)return;h=new bb,i=new _b,i.background=new Se(3359061);const S=_.clientWidth/_.clientHeight;r=new ai(75,S,.1,1e3),r.position.set(0,18,6),r.lookAt(0,0,0),l=new gb({antialias:!0}),l.setSize(_.clientWidth,_.clientHeight),l.shadowMap.enabled=!0,_.appendChild(l.domElement),c=new Ab(l);const x=new Eb(16777215,1);i.add(x);const M=new Mb(16777215,2);M.position.set(10,20,5),M.castShadow=!0,M.shadow.mapSize.width=2048,M.shadow.mapSize.height=2048,i.add(M);const R=new pu({color:15857145}),C=new pu({color:13166281}),y=new pu({color:15857897}),v=new pu({color:16758605}),L=8,D=6,z=[new oe(.1,0),new oe(L*.7,.2),new oe(L,D)],J=new Fh(z,40),I=new Rn(J,R);I.receiveShadow=!0,i.add(I);const N=500,O=500,T=200,E=N+O+T,q=new Ts(1,1,1),st=new Mh(q,C,N),V=new Mh(q,y,O),ht=new Mh(q,v,T);st.instanceMatrix.setUsage(jf),V.instanceMatrix.setUsage(jf),ht.instanceMatrix.setUsage(jf),st.receiveShadow=!0,V.receiveShadow=!0,ht.receiveShadow=!0,i.add(st,V,ht);const dt=[st,V,ht],F=new Array(E).fill(0).map(()=>({width:1.2+Math.random()*.6,height:.05,depth:.1+Math.random()*.1})),Z=F.map(lt=>new tt(lt.width,lt.height,lt.depth)),W=new tt(0,0,0),vt={cabbage1:new Rn(q,C),cabbage2:new Rn(q,y),carrot:new Rn(q,v)};let ct=null;h.postMessage({type:"init",payload:{bowlRadius:L,bowlHeight:D,bowlVertices:J.attributes.position.array,bowlIndices:J.index.array,shredDimensions:F}});const U=new Tb,$=new oe;let gt=null,G=null,ut=!1;const Et=new Da,xt=new tt,kt=new tt;let Pt={x:0,y:0},j={x:0,y:0};const ee=new Pe,Gt=lt=>{$.x=lt.clientX/_.clientWidth*2-1,$.y=-(lt.clientY/_.clientHeight)*2+1,U.setFromCamera($,r);const yt=U.intersectObjects(dt);if(yt.length>0){const St=yt[0],Lt=St.instanceId,At=St.object;let Tt=0;At===st?(Tt=Lt,ct=vt.cabbage1):At===V?(Tt=N+Lt,ct=vt.cabbage2):(Tt=N+O+Lt,ct=vt.carrot),gt=Tt,h.postMessage({type:"dragStart",payload:{shredIndex:Tt}});const jt=St.point.clone();At.getMatrixAt(Lt,ee);const bt=new tt().setFromMatrixPosition(ee);kt.copy(bt).sub(jt);const Ft=new tt,fe=new mr,Wt=new tt;ee.decompose(Ft,fe,Wt),ct.position.copy(Ft),ct.scale.copy(Wt),ct.quaternion.copy(fe),i.add(ct);const Dt=new tt;r.getWorldDirection(Dt),Et.setFromNormalAndCoplanarPoint(Dt,jt)}},ve=lt=>{if(j={x:lt.clientX-Pt.x,y:lt.clientY-Pt.y},Pt={x:lt.clientX,y:lt.clientY},gt!==null&&ct&&($.x=lt.clientX/_.clientWidth*2-1,$.y=-(lt.clientY/_.clientHeight)*2+1,U.setFromCamera($,r),U.ray.intersectPlane(Et,xt))){const yt=xt.add(kt);ct.position.copy(yt),G||(G=new tt),G.copy(yt),ut=!0}},It=()=>{gt!==null&&ct&&(ut&&G&&h.postMessage({type:"dragMove",payload:{shredIndex:gt,position:{x:G.x,y:G.y,z:G.z}}}),h.postMessage({type:"dragEnd",payload:{shredIndex:gt,linvel:{x:j.x*2.5,y:5,z:j.y*2.5}}}),ee.compose(ct.position,ct.quaternion,Z[gt]),gt<N?(st.setMatrixAt(gt,ee),st.instanceMatrix.needsUpdate=!0):gt<N+O?(V.setMatrixAt(gt-N,ee),V.instanceMatrix.needsUpdate=!0):(ht.setMatrixAt(gt-N-O,ee),ht.instanceMatrix.needsUpdate=!0),i.remove(ct),ct=null,gt=null,G=null,ut=!1)},ie=lt=>{lt.preventDefault(),lt.touches.length>0&&Gt({clientX:lt.touches[0].clientX,clientY:lt.touches[0].clientY})},Qt=lt=>{lt.preventDefault(),lt.touches.length>0&&ve({clientX:lt.touches[0].clientX,clientY:lt.touches[0].clientY})},ae=()=>It();_.addEventListener("mousedown",Gt),window.addEventListener("mousemove",ve),window.addEventListener("mouseup",It),_.addEventListener("touchstart",ie,{passive:!1}),window.addEventListener("touchmove",Qt,{passive:!1}),window.addEventListener("touchend",ae),window.addEventListener("touchcancel",ae);const Ce=new tt,P=new mr;h.onmessage=lt=>{const{type:yt,payload:St}=lt.data;if(yt==="transforms"){const Lt=new Float32Array(St);let At=0;for(let Tt=0;Tt<E;Tt++){Ce.set(Lt[At++],Lt[At++],Lt[At++]),P.set(Lt[At++],Lt[At++],Lt[At++],Lt[At++]);const jt=Tt===gt?W:Z[Tt];ee.compose(Ce,P,jt),Tt<N?st.setMatrixAt(Tt,ee):Tt<N+O?V.setMatrixAt(Tt-N,ee):ht.setMatrixAt(Tt-N-O,ee)}dt.forEach(Tt=>{Tt.instanceMatrix.needsUpdate=!0}),h.postMessage({type:"transforms_ack",payload:St},[St])}};const b=()=>{ut&&gt!==null&&G&&(h.postMessage({type:"dragMove",payload:{shredIndex:gt,position:{x:G.x,y:G.y,z:G.z}}}),ut=!1),c.render(i,r),d=requestAnimationFrame(b)};b();const ot=()=>{const lt=_.clientWidth,yt=_.clientHeight;l.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),c.setSize(lt,yt),r.aspect=lt/yt,r.updateProjectionMatrix()};return window.addEventListener("resize",ot),ot(),()=>{window.removeEventListener("resize",ot),_.removeEventListener("mousedown",Gt),window.removeEventListener("mousemove",ve),window.removeEventListener("mouseup",It),_.removeEventListener("touchstart",ie),window.removeEventListener("touchmove",Qt),window.removeEventListener("touchend",ae),window.removeEventListener("touchcancel",ae),cancelAnimationFrame(d),h.postMessage({type:"stop"}),_&&l.domElement&&_.removeChild(l.domElement)}};let p;return m().then(_=>{p=_}).catch(console.error),()=>{p&&p()}},[]),Co.jsx("div",{ref:o,className:"w-full h-full cursor-grab active:cursor-grabbing"})},Cb=()=>Co.jsx("div",{className:"w-screen h-screen overflow-hidden",children:Co.jsx(Rb,{})}),Gv=document.getElementById("root");if(!Gv)throw new Error("Could not find root element to mount to");const wb=ax.createRoot(Gv);wb.render(Co.jsx(KS.StrictMode,{children:Co.jsx(Cb,{})}));
